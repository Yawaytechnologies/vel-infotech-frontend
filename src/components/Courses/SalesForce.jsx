...
export default function JavaCoursePage() {
  ...
  const course = SYLLABI.salesforce;
  /* ===========================
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Salesforce Enquiry:", form);
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
            ...
            <span className="text-yellow-400">Salesforce Training Program</span>
          </h2>

          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Enroll in the <strong>Top Salesforce Training Institute</strong> to launch your career in CRM and cloud solutions.
            </li>
            <li>
              ✅ Learn core topics – <strong>Salesforce Admin, Apex, Visualforce, Lightning, Flow Builder, CRM Integration</strong>.
            </li>
            <li>
              ✅ Build practical skills through <strong>hands-on projects, sandbox environment, and real-world business cases</strong>.
            </li>
            <li>
              ✅ Deep dive into <strong>data modeling, automation, reports & dashboards, and deployment strategies</strong>.
            </li>
            <li>
          ...
          >
            <div>
              ...
              ₹3 LPA to ₹8 LPA <br />
              <span className="text-sm text-gray-300">| Salesforce | Duration: 3 Months</span>
            </div>
          </button>
        </div>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
              Overview of Salesforce Training Program
            </h2>
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Our Salesforce Training Program helps you master the world’s leading CRM platform. Gain hands-on experience in Admin, Developer and Lightning components, preparing you for real roles and certifications.
            </p>
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Salesforce CRM fundamentals & cloud architecture.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Admin: objects, relationships, flows, reports & dashboards.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Developer: Apex, Visualforce & Lightning Web Components (LWC).</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Real projects in sandbox; AppExchange tools & integrations.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Certification prep: Admin, Platform Developer, App Builder.</li>
            </ul>
          </div>
        </div>
      </section>

      {/* Salesforce CTA + Cards */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>✓ Admin & Developer tracks</li>
                <li>✓ Real-time CRM projects</li>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Salesforce Admin", "Apex", "Visualforce", "LWC", "Flow Builder", "AppExchange", "Sales Cloud", "Service Cloud"].map((tool) => (
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["CRM Fundamentals", "Admin Configuration", "Apex Coding", "Lightning Pages", "Workflow Automation", "Deployment & Testing"].map((topic) => (
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>Build & configure Salesforce apps</li>
                <li>Automate business workflows</li>
                <li>Develop & deploy Apex/LWC</li>
                <li>Deliver real-time CRM solutions</li>
              </ul>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div>
                  <input
                    type="text"
                    name="course"
                    placeholder="Type Course (e.g., Salesforce)"
                    value={form.course}
                    onChange={handleChange}
                    onBlur={handleBlur}
