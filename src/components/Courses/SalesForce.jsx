  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        <li>✅ Enroll in the <strong>Top Salesforce Training Institute</strong> to launch your career in CRM and cloud solutions.</li>
        <li>✅ Learn core topics – <strong>Salesforce Admin, Apex, Visualforce, Lightning, Flow Builder, CRM Integration</strong>.</li>
        <li>✅ Build practical skills through <strong>hands-on projects, sandbox environment, and real-world business cases</strong>.</li>
        <li>✅ Get deep insights into <strong>data modeling, automation, reports & dashboards, and deployment strategies</strong>.</li>
        <li>✅ Earn a globally recognized <strong>Salesforce Certification</strong> like Admin, Developer, or App Builder.</li>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our Salesforce Training Program is designed to help you master the world’s leading CRM platform. You'll gain hands-on experience in Salesforce Admin, Developer, and Lightning components, preparing you for real-world roles and Salesforce certifications.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Understand Salesforce CRM fundamentals and cloud architecture.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Learn Salesforce Admin concepts like objects, relationships, workflows, and reports.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Develop skills in Apex programming, Visualforce, and Lightning Web Components (LWC).
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Gain experience with real-world projects using sandbox environments and AppExchange tools.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Prepare for Salesforce certifications like Admin, Platform Developer, and App Builder.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
...
<section className="w-full px-6 py-20 bg-gradient-to-b from-[#] to-[#] text-black">
  ...
  <div className="max-w-7xl mx-auto text-center mb-16">
    ...
    <p className="text-lg md:text-xl text-white mb-6">
      Learn Salesforce Admin, Apex Development, Lightning Components, CRM Integration, and Deployment with hands-on projects and job-oriented training.
    </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          ...
          <li>✓ Real-time CRM project implementation</li>
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Salesforce Admin", "Apex", "Visualforce", "LWC", "Flow Builder", "AppExchange", "Sales Cloud", "Service Cloud"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["CRM Fundamentals", "Admin Configuration", "Apex Coding", "Lightning Pages", "Workflow Automation", "Deployment & Testing"].map((topic, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          <li>Build and configure Salesforce apps</li>
          <li>Automate business workflows</li>
          <li>Develop and deploy Apex/Lightning components</li>
          <li>Work on real-time CRM solutions</li>
        </ul>
      </div>
    </div>
