  ...
  export default function TalentAquisitionPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.talentaqu;
  ...
  Master<span className="text-yellow-400"> Talent Acquisition Skills</span> 
  <br />with Hands-On Practical Training
</h2>

<ul className="space-y-3 mt-6 text-lg">
  <li>
    ✅ Join the <strong>Top Talent Acquisition Training Institute</strong> to learn effective hiring strategies, recruitment processes, and talent management best practices.
  </li>
  <li>
    ✅ Learn <strong>Talent Sourcing, Recruitment & Selection, Candidate Screening, Interviewing Techniques, Employer Branding, Onboarding Strategies, Recruitment Analytics, HR Policies & Compliance, and Communication Skills</strong>.
  </li>
  <li>
    ✅ Work on <strong>practical projects</strong> including creating job descriptions, designing recruitment campaigns, and implementing onboarding plans.
  </li>
  <li>
    ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
  </li>
  <li>
    ✅ Earn an industry-recognized <strong>Talent Acquisition Certification</strong>.
  </li>
  <li>
  ...
  Become an expert in Talent Acquisition and recruitment strategies in 1–2 Months
</p>
  ...
  Overview of Talent Acquisition Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our Talent Acquisition Training equips you with the skills and practical knowledge required to manage
  end-to-end recruitment processes, source top talent, and streamline hiring strategies effectively.
  This course covers talent sourcing, candidate screening, interview techniques, employer branding, 
  recruitment analytics, and strategic workforce planning. You’ll also work on real-world recruitment tasks 
  and receive career guidance to kick-start your journey as a Talent Acquisition professional.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From Talent Acquisition Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Understand talent acquisition fundamentals, recruitment lifecycle, and workforce planning.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn candidate sourcing, screening, interviewing, and onboarding techniques.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in employer branding, recruitment marketing, and talent engagement strategies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on practical recruitment projects such as sourcing campaigns, interview schedules, and hiring dashboards.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn best practices in recruitment analytics, reporting, and compliance.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Receive career support including resume building, mock interviews, and placement assistance.
  </li>
</ul>
  ...
  Master Talent Acquisition skills with structured modules covering 
  recruitment lifecycle management, candidate sourcing and screening, 
  interview techniques, employer branding and talent marketing, 
  onboarding strategies, recruitment analytics and reporting, 
  stakeholder management, candidate engagement, compliance and legal aspects, 
  workforce planning, recruitment process optimization, practical hiring projects, 
  and best practices for building efficient talent acquisition operations in any organization.
</p>
