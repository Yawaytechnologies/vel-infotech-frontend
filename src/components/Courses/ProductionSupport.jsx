...
export default function ProductionSupportPage() {
  ...
  const courseJsonLd = {
    ...
    "@type": "Course",
    name: "Production Support Program",
    description:
      "Join our Production Support Program to master real-time IT support, incident management, and monitoring tools. Get job-ready in just 3 months!",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      url: "https://www.velinfotech.com/all-courses/production-support-program",
    },
    hasCourseInstance: {
      "@type": "CourseInstance",
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
                ✅ Learn ITIL-based <strong>Incident / Problem / Change</strong>{" "}
                management.
              </li>
              <li>
                ✅ Hands-on with <strong>Linux, SQL, Shell</strong> & service
                monitoring.
              </li>
              <li>
                ✅ Master <strong>logs, alerts, runbooks, on-call & RCA</strong>{" "}
                workflows.
              </li>
              <li>
                ✅ Tools overview:{" "}
                <strong>
                  ServiceNow/Jira, Splunk, Grafana, Prometheus, Postman
                </strong>
                .
              </li>
              <li>
                ✅ Flexible modes –{" "}
                <strong>Weekday / Weekend / Fast-track</strong>.
              </li>
              <li>
                ✅ <strong>Interview prep</strong>, resume support & job
                referrals.
              </li>
            </ul>
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Production Support Engineer in 3 Months
            </p>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                ...
                triage incidents, analyze logs, stabilize applications,
                coordinate with dev teams, and restore services quickly while
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> ITIL
                  foundations: Incident, Problem, Change.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Monitoring &
                  alert triage (thresholds, noise reduction).
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Log analysis
                  with Splunk/ELK, dashboards with Grafana.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Linux basics,
                  Shell scripting, SQL for prod checks.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Runbooks,
                  on-call, comms, and post-incident RCA.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Change &
                  release windows, canary/rollback basics.
                </li>
              </ul>
            </div>
          </div>
