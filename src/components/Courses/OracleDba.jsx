  ...
  export default function OracleDbaPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.oracleDba;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
             ...
             <li>
  ✅ Join the <strong>Best Oracle DBA Training Institute</strong> to master
  database administration and management.
</li>
<li>
  ✅ Learn <strong>Oracle Architecture, Database Installation, Backup & Recovery, Performance Tuning, Security, Data Guard, RAC, RMAN</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world database administration projects</strong> with hands-on labs and case studies.
</li>
<li>
...
<li>
  ...
  <strong>Oracle DBA Certification</strong>.
</li>
<li>
  ...
  placement assistance.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Oracle DBA expert in 3 Months
            </p>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
                Overview of Oracle SQL Training Course
              </h2>
  ...
  Our Oracle DBA Training equips you with the knowledge and hands-on expertise
  required to become an industry-ready database administrator. This course
  covers Oracle Architecture, Database Installation & Configuration, Backup
  & Recovery, Performance Tuning, Security, Data Guard, RAC, RMAN, and more.
  You’ll also work on real-world DBA projects, manage high-availability
  environments, and receive interview preparation support to kick-start your
  career in database administration and management.
</p>
  ...
  What You’ll Learn From Oracle DBA Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in Oracle architecture and database administration concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to install, configure, and manage Oracle databases, users, roles, and privileges.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in backup & recovery using RMAN, Data Guard, and flashback technologies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on performance tuning, storage management, and high-availability solutions including RAC.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build real-world projects including database optimization, monitoring, and disaster recovery simulations.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Oracle DBA with structured modules covering Oracle architecture, Database Installation & Configuration, User & Security Management, Backup & Recovery, Performance Tuning, Data Guard, RAC, RMAN, and more.
</p>
