  ...
  export default function DotnetFullstackPage() {
    ...
    const course = SYLLABI.dotnetfullstack;
...
<li>
  ✅ Join the <strong>Best .NET Full Stack Training Institute</strong> to master
  end-to-end application development using Microsoft technologies.
</li>
<li>
  ✅ Learn <strong>VB.NET / C# Fundamentals, ASP.NET, ASP.NET Core MVC, Web API, 
  JavaScript, HTML, CSS, Frontend Frameworks (Angular, React, Vue.js), 
  SQL Server / Oracle / MySQL / PostgreSQL, Azure Cloud Services, 
  Docker / Kubernetes, and DevOps Practices (CI/CD)</strong>.
</li>
<li>
  ✅ Work on <strong>real-world .NET Full Stack projects</strong> including scalable,
...
<li>
  ✅ Earn an industry-recognized <strong>.NET Full Stack Developer Certification</strong>.
</li>
<li>
  ...
  Become an expert .NET Full Stack Developer in 4–5 Months
</p>
  ...
  Overview of .NET Full Stack Developer Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our .NET Full Stack Training equips you with the skills and hands-on expertise
  required to build scalable, secure, and enterprise-level web applications. 
  This course covers VB.NET / C# Fundamentals, ASP.NET, ASP.NET Core MVC, 
  Web API, HTML, CSS, JavaScript, Frontend Frameworks (Angular, React, Vue.js), 
  SQL Server / Oracle / MySQL / PostgreSQL, Azure Cloud Services, Docker / Kubernetes, 
  CI/CD DevOps Practices, and best practices for enterprise application development. 
  You’ll also work on real-world projects, deploy applications, and receive interview 
  preparation support to kick-start your career as a .NET Full Stack Developer.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From .NET Full Stack Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in .NET concepts, architecture, and full-stack development.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to develop dynamic web applications using ASP.NET, ASP.NET Core MVC, and Web API.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in frontend technologies including HTML, CSS, JavaScript, and modern frameworks like Angular, React, or Vue.js.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world projects integrating frontend and backend, with database and cloud services.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn deployment strategies, Azure cloud services, Docker / Kubernetes, and CI/CD DevOps practices.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master .NET Full Stack Development with structured modules covering VB.NET / C# Fundamentals, 
  ASP.NET, ASP.NET Core MVC, Web API, HTML, CSS, JavaScript, Frontend Frameworks (Angular, React, Vue.js), 
  SQL Server / Oracle / MySQL / PostgreSQL, Azure Cloud Services (App Service, SQL Database), 
  Docker & Kubernetes, CI/CD DevOps Practices, Security, Performance Optimization, 
  and Enterprise Application Best Practices.
</p>
