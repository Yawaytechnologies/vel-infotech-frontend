  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our SQL Developer Training program equips you with the skills needed to query, manage, and manipulate relational databases using SQL. This course is ideal for beginners and professionals looking to sharpen their database knowledge and includes hands-on practice with real-world datasets and queries.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Understand database concepts and relational models with real-time examples.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Master SQL commands: SELECT, INSERT, UPDATE, DELETE, and filtering data.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Work with joins, subqueries, views, indexes, and constraints effectively.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Practice writing complex queries using group by, having, and nested queries.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Learn normalization, ER modeling, and real-time database design.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Prepare for jobs with resume support, mock interviews, and SQL assessments.
        </li>
      </ul>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["MySQL", "PostgreSQL", "SQL Server", "SQL Developer", "GitHub"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Joins", "Subqueries", "Views", "Indexes", "Normalization", "Aggregate Functions"].map((topic, i) => (
