        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              ...
              metrics, forecasting, and stakeholder management. Get prepared for
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Jira/Confluence:
                boards, workflows, dashboards & reports.
              </li>
              <li className="flex items-start gap-3">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                ...
                events, user stories & AC, estimation (story points), velocity,
                burndown/burnup, release planning & forecasting.
              </p>
            </div>
