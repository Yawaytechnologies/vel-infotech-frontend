...
export default function SoftwareTesting() {
  ...
  const courseJsonLd = {
    ...
    description:
      "Learn software testing techniques, manual and automation tools, and quality assurance practices. Gain hands-on experience to ensure bug-free, reliable software.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
  ...
  return (
    <>
      ...
      <Seo
        title="Software Testing Course in Chennai | Vell InfoTech"
        description="Join Vell InfoTech's Software Testing Program in Chennai. Master manual testing, Selenium automation, JIRA & API testing with live projects. Certification & 100% placement support."
        keywords="software testing course in chennai, software testing training institute in Chennai, qa engineer salary in india, manual testing course in Chennai, software testing course with placement, Software testing course in chennai, Software testing course with placement, Software testing course India, Software testing for beginners"
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
                ✅ Learn core tools –{" "}
                <strong>
                  Selenium, Java, TestNG, JIRA, Postman, SQL, API Testing
                </strong>
                .
              </li>
              <li>
                ✅ Work on real-time projects with{" "}
                <strong>
                  end-to-end functional, regression, and automation testing
                </strong>
                .
              </li>
              <li>
              ...
              <li>
                ...
                <strong>Software Testing Certification</strong>.
              </li>
              <li>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                Our Software Testing Training program is designed to provide
                end-to-end knowledge of manual and automation testing. Learn how
                to ensure software quality through testing methodologies, tools,
                and real-world project simulations covering both web and mobile
                applications.
              </p>
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Understand the fundamentals of manual testing and software
                  development life cycle (SDLC).
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Write effective test cases and perform test execution and
                  defect tracking.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Gain hands-on experience with automation tools like Selenium
                  and TestNG.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Learn API testing using Postman and test automation using
                  frameworks.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Get exposure to Agile testing practices, JIRA, and bug
                  lifecycle management.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Receive career guidance with resume prep, mock interviews, and
                  job assistance.
                </li>
              </ul>
            </div>
        ...
        <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
          <div className="max-w-7xl mx-auto text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-white">
              Become a Certified Software Testing Engineer
            </h2>
            <p className="text-lg md:text-xl text-white mb-6">
              Learn Manual Testing, Selenium, TestNG, API Testing, and
              Automation Frameworks from industry experts.
            </p>
            ...
            <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                  ...
                  <li>Automation with Selenium & Java</li>
