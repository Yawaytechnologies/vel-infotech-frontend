      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
          ...
          <p className="mb-4 text-lg">
            Become a Python Full Stack Developer in 3 Months
          </p>
          ...
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10 text-gray-900">
            ...
            <ul className="space-y-4 text-base md:text-lg">
              <li className="flex items-start gap-3">
                ...
                Master Python fundamentals including data types, control
                structures, functions, OOP, and modules.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
                Create responsive frontends using HTML, CSS, JavaScript, and
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
                Work on real-world capstone projects simulating business
                use-cases and product development.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
                Get career support with resume building, mock interviews, and
                coding assessments.
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "Django", "Flask", "React", "GitHub"].map(
                  (tool) => (
                    <span
                      key={tool}
