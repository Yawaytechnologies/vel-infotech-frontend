  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
        ...
        <span className="text-yellow-400">Python Full Stack Developer Course</span>
      </h2>

      <ul className="space-y-3 mt-6 text-lg">
        <li>✅ Join the <strong>Best Python Training Institute</strong> to master Core & Advanced Python.</li>
        <li>✅ Learn Python Full Stack – <strong>Django, Flask, React, Node.js</strong>.</li>
        ...
        <li>✅ Earn an industry-accepted <strong>Python Developer Certification</strong>.</li>
    ...
    <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
      ...
      <p className="mb-4 text-lg">Become a Python Full Stack Developer in 3 Months</p>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our Python Full Stack Training program is designed to make you an industry-ready developer with deep understanding of both frontend and backend development. The course covers Python programming, Django, REST APIs, MySQL, HTML, CSS, JavaScript, React.js, and more. You’ll also build real-world applications, learn deployment practices, and receive comprehensive interview preparation.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Master Python fundamentals including data types, control structures, functions, OOP, and modules.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Build robust backends using Django and Flask, and integrate them with MySQL for data persistence.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Create responsive frontends using HTML, CSS, JavaScript, and React.js for modern UI development.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Learn to deploy web applications using GitHub, Docker, and cloud platforms like Heroku or Render.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Work on real-world capstone projects simulating business use-cases and product development.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Get career support with resume building, mock interviews, job referrals, and coding assessments.
        </li>
      </ul>
    </div>
  </div>
...
<section className="w-full px-6 py-20 bg-gradient-to-b from-[#] to-[#] text-black">
  ...
  <div className="max-w-7xl mx-auto text-center mb-16">
    ...
    <p className="text-lg md:text-xl text-white mb-6">
      Master Python, Django, REST APIs, React, and more through practical, expert-led training.
    </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          <li>✓ Python, Django, REST APIs, Full Stack</li>
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Python", "Django", "Flask", "React", "GitHub"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Django", "Flask", "SQLAlchemy", "Pandas", "NumPy", "FastAPI"].map((fw, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          ...
          <li>Data handling with Python libraries</li>
          <li>Version control, CI/CD pipelines</li>
          <li>Deployment, hosting & testing apps</li>
        </ul>
      </div>
    </div>
