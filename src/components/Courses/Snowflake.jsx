  ...
  export default function SnowflakePage() {
    ...
    const course = SYLLABI.snowflake;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
  ✅ Join the <strong>Best Snowflake Training Institute</strong> to master
  cloud data warehousing and analytics.
</li>
<li>
  ✅ Learn <strong>Snowflake Architecture, SQL, Virtual Warehouses, Data Sharing, Security & BI Integrations</strong> and more.
</li>
<li>
...
<li>
  ...
  <strong>Snowflake Certification</strong>.
</li>
<li>
  ...
  placement assistance.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Snowflake expert in 3 Months
            </p>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
                Overview of Snowflake Training Course
              </h2>
  ...
  Our Snowflake Training equips you with the skills and hands-on expertise
  required to become an industry-ready cloud data professional. This course
  covers Snowflake Architecture, Virtual Warehouses, SQL, Data Sharing,
  Security, and BI Integrations. You’ll also work on real-world datasets,
  build cloud-based data pipelines, and receive interview preparation
  support to kick-start your career in data warehousing and analytics.
</p>
  ...
  What You’ll Learn From Snowflake Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build a strong foundation in cloud data warehousing concepts and Snowflake architecture.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Learn to create and manage Snowflake databases, schemas, and virtual warehouses.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Gain expertise in writing Snowflake SQL for querying, transformations, and analytics.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Work with advanced features like Time Travel, Cloning, and Data Sharing.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build end-to-end real-world projects including data pipelines, BI dashboards, and analytics use cases.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Snowflake with structured modules covering Architecture, Virtual Warehouses, SQL, Data Sharing, Security, BI Integrations, and more.
</p>
