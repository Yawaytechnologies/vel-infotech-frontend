...
export default function PlsqlCoursePage() {
  ...
  const courseJsonLd = {
    ...
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      url: "https://www.vellinfotech.com/all-courses/pl-sql-developer-course",
    },
    image: "https://cdn-icons-png.flaticon.com/512/16990/16990193.png",
    hasCourseInstance: [
      {
  ...
  return (
    <>
          ...
          <div className="flex-1">
            ...
            <button
              className="group relative bg-neutral-800 h-auto min-h-[64px] w-full sm:w-80 border border-white text-left p-4 text-gray-50 text-base font-bold rounded-lg overflow-hidden mt-8
                       ...
                       hover:decoration-2 hover:text-rose-300 duration-500 group-hover:before:duration-500 group-hover:after:duration-500
          ...
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>Master Oracle SQL
                basics including SELECT queries, joins, subqueries, and
                aggregate functions.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>Develop advanced
                PL/SQL scripts using procedures, functions, packages, and
                triggers.
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>Gain exposure to
      ...
      <section className="w-full px-6 py-20 bg-gradient-to-b from-[#005BAC] to-[#003c6a] text-black">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-white mb-6">
            Learn Oracle SQL, PL/SQL procedures, triggers, tuning, and more with
      ...
      {/* Toasts */}
      <ToastContainer newestOnTop limit={2} className="!z-[9999]" />
