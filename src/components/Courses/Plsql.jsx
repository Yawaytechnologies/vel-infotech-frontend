  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
        ...
        <span className="text-yellow-400">PL/SQL Developer Course</span>
      </h2>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
        Overview of PL/SQL Developer Course
      </h2>
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our PL/SQL Developer Training program is designed to help you become proficient in writing efficient queries, procedures, and database logic using Oracle SQL and PL/SQL. You'll gain hands-on experience with stored procedures, triggers, cursors, and performance tuning, preparing you for real-world database development roles and placement success.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Master Oracle SQL basics including SELECT queries, joins, subqueries, and aggregate functions.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Develop advanced PL/SQL scripts using procedures, functions, packages, and triggers.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Learn exception handling, cursors, and PL/SQL records for dynamic database control.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Work with real-time scenarios using HR, finance, and inventory database projects.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Gain exposure to performance tuning and query optimization techniques.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Receive job assistance through resume building, mock interviews, and Oracle-based assessments.
        </li>
      </ul>
    </div>
  </div>
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          ...
          <li>✓ Resume & placement preparation</li>
        </ul>
      </div>
    </div>
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          ...
          <li>Performance tuning & debugging</li>
        </ul>
      </div>
    </div>
