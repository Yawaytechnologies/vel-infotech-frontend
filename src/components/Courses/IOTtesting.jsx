  ...
  export default function IOTtestingPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.iotTesting;
  ...
  <span className="text-yellow-400">
    IoT Testing Training Course
  </span>
</h2>

<ul className="space-y-3 mt-6 text-lg">
  <li>
    ✅ Join the <strong>Best IoT Testing Training Institute</strong> to master
    testing of IoT devices, applications, and end-to-end ecosystems.
  </li>
  <li>
    ✅ Learn <strong>IoT Architecture, Protocols (MQTT, CoAP, HTTP, Zigbee, LoRa), Functional Testing, Connectivity Testing, Performance Testing, Security Testing, and Automation Tools</strong>.
  </li>
  <li>
    ✅ Work on <strong>real-world IoT testing projects</strong> including smart devices, wearable tech, and industrial IoT case studies.
  </li>
  <li>
  ...
  <li>
    ...
    <strong> IoT Testing Certification</strong>.
  </li>
  <li>
  ...
  Become an expert IOT Tester in 2–3 Months
</p>
  ...
  Overview of IoT Testing Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our IoT Testing Training equips you with the skills and hands-on expertise
  required to test, validate, and ensure the performance, security, and reliability
  of IoT devices and ecosystems. This course covers IoT Architecture, Communication Protocols
  (MQTT, CoAP, HTTP, Zigbee, LoRa), Functional Testing, Connectivity Testing,
  Performance & Load Testing, Security Testing, and Automation Tools. You’ll also work on
  real-world IoT testing projects, simulate device communication, and receive interview preparation
  support to kick-start your career in IoT quality assurance and validation.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From IoT Testing Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in IoT architecture, device communication, and testing methodologies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to perform functional, performance, interoperability, and connectivity testing for IoT systems.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in IoT protocols like MQTT, CoAP, Zigbee, and LoRa, and their testing approaches.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world IoT testing projects including smart devices, industrial IoT, and wearable technologies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Implement IoT test automation frameworks, monitoring tools, and security validation techniques.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master IoT Testing with structured modules covering IoT Architecture, Communication Protocols 
  (MQTT, CoAP, Zigbee, LoRa, HTTP), Functional & Connectivity Testing, Performance & Load Testing, 
  Security & Penetration Testing, Test Automation Frameworks, Device & Sensor Validation, 
  Interoperability Testing, Cloud Integration, and more.
</p>
