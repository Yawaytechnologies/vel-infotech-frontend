  ...
  export default function BlockchainCoursePage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.blockchain;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
  ✅ Join the <strong>Best Blockchain Training Institute</strong> to
  master Blockchain fundamentals & advanced concepts.
</li>
<li>
  ✅ Learn <strong>Ethereum, Hyperledger, Smart Contracts, Solidity</strong> and more.
</li>
<li>
  ✅ Build real-world decentralized applications (DApps) with hands-on{" "}
...
<li>
  ...
  <strong>Blockchain Developer Certification</strong>.
</li>
<li>
...
<li>
  ...
  referrals.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Blockchain Developer in 3 Months
            </p>
  ...
  Our Blockchain Training equips you with the knowledge and
  hands-on experience required to become an industry-ready
  blockchain developer. This course covers core blockchain concepts,
  cryptography, distributed ledgers, smart contracts, Ethereum,
  Hyperledger, Solidity programming, and more. You’ll also work on
  real-world decentralized applications (DApps), explore NFTs and Web3,
  practice deployment on test networks, and receive interview preparation
  support to accelerate your career in blockchain technology.
</p>


              {/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From Blockchain Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Understand the fundamentals of Blockchain technology, distributed ledgers,
    and cryptographic principles.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Develop <strong>smart contracts</strong> using Solidity and deploy them on
    Ethereum and other blockchain platforms.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build real-world <strong>Decentralized Applications (DApps)</strong> and
    integrate them with blockchain networks.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain hands-on experience with <strong>Ethereum, Hyperledger, Web3.js</strong>,
    and blockchain deployment tools.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Explore advanced topics such as <strong>NFTs, DeFi, and Web3 ecosystems</strong>
    to stay industry-relevant.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Participate in capstone projects and receive career support including
    resume building, mock interviews, and technical assessments.
  </li>
  ...
  Master Blockchain Development with structured modules covering Blockchain
  fundamentals, Cryptography, Ethereum, Hyperledger, Smart Contracts, and DApps.
</p>
