  ...
  export default function HadoopSparkPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.hadoopspark;
  ...
  <span className="text-yellow-400">
   Big Data Hadoop & Spark Full Stack Course
</span>
...
<li>
  ✅ Join the <strong>Best Big Data Training Institute</strong> to master 
  end-to-end data processing, analytics, and scalable big data application development.
</li>
<li>
  ✅ Learn <strong>Hadoop Ecosystem (HDFS, MapReduce, YARN), Apache Spark, PySpark, Hive, Pig, Sqoop, Flume, Kafka, 
  NoSQL Databases (HBase, Cassandra), Data Warehousing, ETL Processes, 
  Data Analytics & Visualization (Python, R, Tableau), and Big Data Security & Optimization</strong>.
</li>
<li>
  ✅ Work on <strong>real-world Big Data projects</strong> including distributed data processing, batch & real-time analytics, and enterprise applications.
</li>
<li>
  ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
</li>
<li>
  ✅ Earn an industry-recognized <strong>Big Data Hadoop & Spark Certification</strong>.
</li>
<li>
  ...
  Become an expert in Big Data Hadoop & Spark Full Stack Development in 3–4 Months
</p>
  ...
  Overview of Big Data Hadoop & Spark Full Stack Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our Big Data Hadoop & Spark Full Stack Training equips you with the skills and hands-on expertise
  required to build end-to-end big data applications using Hadoop ecosystem, Spark, and associated
  technologies. This course covers Hadoop HDFS, MapReduce, Spark Core, Spark SQL, Spark Streaming,
  Hive, Pig, Kafka, NoSQL databases, and Best Practices for big data full stack development.
  You’ll also work on real-world projects, process and analyze large datasets, and receive interview
  preparation support to kick-start your career as a Big Data Full Stack Developer.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From Big Data Hadoop & Spark Full Stack Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in Hadoop ecosystem, HDFS, and distributed computing concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn data processing and analytics using Spark Core, Spark SQL, and Spark Streaming.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in working with Hive, Pig, and Kafka for big data pipelines.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world big data projects integrating Hadoop and Spark technologies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn NoSQL databases like HBase and MongoDB and understand ETL & data workflow management.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Big Data Full Stack development with structured modules covering Hadoop HDFS, 
  MapReduce, Spark Core, Spark SQL, Spark Streaming, Hive, Pig, Kafka, NoSQL databases 
  (HBase, MongoDB), Data Ingestion & ETL, Data Pipeline Management, Cluster Management 
  (YARN, Mesos), Performance Optimization, Data Security & Governance, and best practices 
  for building scalable end-to-end big data applications.
</p>
