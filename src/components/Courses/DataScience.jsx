  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        ...
        <li>✅ Build real-world data science projects with hands-on <strong>model development experience</strong>.</li>
        <li>✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.</li>
        <li>✅ Earn a recognized <strong>Data Science Certification</strong> to boost your resume.</li>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our Data Science Training program is designed to equip you with in-demand skills in data analytics, machine learning, and statistical modeling. You'll master tools like Python, Pandas, NumPy, Scikit-learn, and visualization platforms like Tableau. The course includes real-world projects and industry applications to help you succeed in data-driven roles.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Master Python for data analysis, including libraries like Pandas, NumPy, and Matplotlib.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Build predictive models using machine learning algorithms in Scikit-learn.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Gain hands-on experience with data preprocessing, cleaning, and transformation techniques.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Perform data visualization using libraries like Seaborn and tools like Tableau or Power BI.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Explore real-world datasets and work on projects in healthcare, finance, and e-commerce domains.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Get career support with resume building, mock interviews, job referrals, and case studies.
        </li>
      </ul>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Python", "Pandas", "NumPy", "Scikit-learn", "Tableau", "Power BI"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Data Analysis", "EDA", "Machine Learning", "SQL", "Statistics", "Model Evaluation"].map((topic, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          ...
          <li>Deploying and testing ML solutions</li>
        </ul>
      </div>
    </div>
