  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
        ...
        <span className="text-yellow-400">ETL Testing Program</span>
      </h2>

      <ul className="space-y-3 mt-6 text-lg">
        <li>✅ Enroll in the <strong>Top ETL Testing Institute</strong> to become a skilled data validation and QA specialist.</li>
        <li>✅ Learn key concepts – <strong>ETL Process, Data Warehousing, SQL, Informatica, Talend, SSIS</strong>.</li>
        <li>✅ Gain hands-on experience with <strong>data extraction, transformation, and loading validations</strong>.</li>
        <li>✅ Understand <strong>data mapping, schema comparison, and business rule verification</strong>.</li>
        <li>✅ Get certified with a professional <strong>ETL Testing Certification</strong>.</li>
        <li>✅ Career support: Real-time projects, resume building, mock interviews & job referrals.</li>
      </ul>
    ...
    <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
      ...
      <p className="mb-4 text-lg">Become a Selenium Testing Expert in 3 Months</p>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
        Overview of ETL Testing Course
      </h2>
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our ETL Testing Training program is designed to make you proficient in validating data movement, transformation, and loading processes. You'll learn ETL tools, SQL, and data warehouse concepts while gaining hands-on experience with real-time data testing projects.
      </p>

      {/* What You’ll Learn */}
      <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
        What You’ll Learn From ETL Testing Training
      </h3>
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Understand ETL concepts and Data Warehouse architecture.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Write complex SQL queries for data validation and transformation testing.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
        ...
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Gain hands-on with tools like Informatica, Talend, SSIS, and DataStage.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Learn about scheduling tools and automation using Control-M or similar.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Get career guidance with mock interviews, resume building & placement support.
        </li>
      </ul>
    </div>
  </div>
...
<section className="w-full px-6 py-20 bg-gradient-to-b from-[#] to-[#] text-black">
  ...
  <div className="max-w-7xl mx-auto text-center mb-16">
    <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-white">
      Become a Certified ETL Testing Professional
    </h2>
    <p className="text-lg md:text-xl text-white mb-6">
      Learn ETL Concepts, Data Warehousing, SQL, Tools like Informatica & SSIS, and validate end-to-end data pipelines.
    </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          <li>✓ ETL + Data Warehouse Testing</li>
          <li>✓ Real-time live project implementation</li>
          <li>✓ Resume prep & mock interviews</li>
          <li>✓ Industry-relevant job-oriented modules</li>
        </ul>
      </div>
    </div>
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Informatica", "SSIS", "SQL", "Talend", "DataStage", "Control-M", "Excel", "Unix Shell"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["ETL Workflow", "Data Validation", "Data Warehouse Concepts", "Source-to-Target Mapping", "SQL Queries", "Reporting & Reconciliation"].map((topic, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          <li>Write complex SQL for data validation</li>
          <li>Perform end-to-end ETL testing</li>
          <li>Validate data accuracy in pipelines</li>
          <li>Test scheduling and automation jobs</li>
        </ul>
      </div>
    </div>
