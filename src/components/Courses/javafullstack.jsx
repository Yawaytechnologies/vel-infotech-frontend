  ...
  export default function JavaFullstackPage() {
    ...
    const course = SYLLABI.javafullstack;
...
<li>
  ✅ Join the <strong>Best Java Full Stack Training Institute</strong> to master 
  end-to-end web and enterprise application development using Java technologies.
</li>
<li>
  ✅ Learn <strong>Core Java, Advanced Java, Servlets, JSP, JDBC, Spring Framework, 
  Spring Boot, Hibernate, RESTful APIs, Frontend Technologies (HTML, CSS, JavaScript, React), 
  MVC Architecture, Dependency Injection, Security, and Integration with Databases</strong>.
</li>
<li>
  ✅ Work on <strong>real-world Java Full Stack projects</strong> including scalable web and enterprise applications.
</li>
<li>
  ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
</li>
<li>
  ✅ Earn an industry-recognized <strong>Java Full Stack Certification</strong>.
</li>
<li>
  ...
  Become an expert Java Full Stack Developer in 3–4 Months
</p>
  ...
  Overview of Java Full Stack Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our Java Full Stack Training equips you with the skills and hands-on expertise
  required to build end-to-end web applications using both frontend and backend technologies.
  This course covers Core Java, J2EE, Servlets, JSP, JDBC, Spring, Hibernate, REST APIs,
  MVC Architecture, React.js, MySQL, and Best Practices for full stack development.
  You’ll also work on real-world projects, deploy applications, and receive interview
  preparation support to kick-start your career as a Java Full Stack Developer.
</p>
...
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    ...
    Build a strong foundation in Core Java, OOPs concepts, and web application architecture.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn frontend development using HTML, CSS, JavaScript, and React.js.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in backend development with Servlets, JSP, JDBC, Spring Boot, and Hibernate.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world full stack projects integrating frontend and backend technologies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn database management with MySQL and understand RESTful APIs for application integration.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Java Full Stack development with structured modules covering Core Java, 
  J2EE, Servlets, JSP, JDBC, Spring & Spring Boot, Hibernate, RESTful Web Services, 
  MVC Architecture, React.js for frontend, MySQL database integration, Session Management, 
  Security, Deployment in Application Servers (Tomcat, JBoss, WebLogic), 
  Performance Optimization, Full Stack Best Practices, and more.
</p>
