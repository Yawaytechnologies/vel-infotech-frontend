  ...
  export default function ApiTestingPage() {
    ...
    const course = SYLLABI.apiTesting;
...
<ul className="space-y-3 mt-6 text-lg">
 <li>
  ✅ Join the <strong>Best API Testing Training Institute</strong> to master
  REST, SOAP, and end-to-end API testing with automation.
</li>
<li>
  ✅ Learn <strong>API Testing Fundamentals, REST & SOAP Concepts, HTTP Methods, 
  Status Codes & Headers, Authentication & Authorization (OAuth, JWT, API Keys), 
  Postman, REST Assured / JavaScript Automation, Performance Testing, Security Testing, 
  Test Automation Framework Design, Reporting, and CI/CD Integration</strong>.
</li>
<li>
  ✅ Work on <strong>real-world API testing projects</strong> including e-commerce, 
  banking, and enterprise application APIs.
</li>
<li>
  ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
</li>
<li>
  ✅ Earn an industry-recognized <strong>API Testing Certification</strong>.
</li>
<li>
  ...
  Become an expert Api Tester in 2 Months
</p>
  ...
  Overview of Api Testing Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our API Testing Training equips you with the skills and hands-on expertise
  required to validate, automate, and secure APIs for modern applications. 
  This course covers API Testing Fundamentals, REST & SOAP Concepts, HTTP Methods, 
  Status Codes & Headers, Authentication & Authorization (OAuth, JWT, API Keys), 
  Postman, REST Assured / JavaScript Automation, Performance & Security Testing, 
  Test Automation Framework Design, Reporting, and CI/CD Integration. You’ll also work on 
  real-world API testing projects, automate API workflows, and receive 
  interview preparation support to kick-start your career in API testing and quality engineering.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From API Testing Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in API testing concepts, protocols, and automation strategies.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to test REST and SOAP APIs, validate responses, and handle authentication and security.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in API automation using Postman, REST Assured, or JavaScript-based frameworks.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world API testing projects including e-commerce, banking, and enterprise applications.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Implement API test automation in CI/CD pipelines using Jenkins, GitHub Actions, or GitLab.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master API Testing with structured modules covering API Testing Fundamentals, 
  REST & SOAP Concepts, HTTP Methods, Status Codes & Headers, Authentication & Authorization (OAuth, JWT, API Keys), 
  Functional & Integration Testing, Performance & Load Testing, Security Testing, 
  Test Automation Framework Design, Postman / REST Assured / JavaScript Automation, 
  Mocking & Stubbing, Assertions & Debugging, Reporting & Coverage, CI/CD Integration, and more.
</p>
