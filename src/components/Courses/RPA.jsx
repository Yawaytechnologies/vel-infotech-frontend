      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
            ...
            <span className="text-yellow-400">RPA (Robotic Process Automation) Training Program</span>
          </h2>

          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Enroll in the <strong>Top RPA Training Institute</strong> to build a rewarding career in automation and
              digital workforce technology.
            </li>
            <li>
              ✅ Learn core tools – <strong>UiPath, Automation Anywhere, Blue Prism, Power Automate</strong>, and bot
              development.
            </li>
            <li>
              ✅ Hands-on experience via <strong>real-time projects, bot development & business process automation</strong>.
            </li>
            <li>
              ✅ Master <strong>workflow design, data scraping, exception handling & orchestrators</strong>.
            </li>
            <li>
              ✅ Earn <strong>RPA Certifications</strong> like UiPath Associate or Blue Prism Developer.
            </li>
            <li>
          ...
          >
            <div>
              ...
              ₹3 LPA to ₹8 LPA <br />
              <span className="text-sm text-gray-300">| RPA Training | Duration: 3 Months</span>
            </div>
          </button>
        </div>
        ...
        <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
          ...
          <p className="mb-4 text-lg">Become a Robotic Process Automation (RPA) Expert in Just 3 Months</p>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
              Overview of Robotic Process Automation (RPA) Training Program
            </h2>
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Our RPA Training helps you transform manual workflows into scalable bots. Get hands-on with UiPath,
              Automation Anywhere, and Blue Prism to prepare for industry certifications and real-world roles.
            </p>

            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">What You’ll Learn From RPA Training</h3>
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> RPA fundamentals, benefits & use cases.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Automating processes with UiPath, Blue Prism & Automation Anywhere.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Bots, control flow, selectors & exception handling.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Orchestrators, triggers & reusable components.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Certification prep: UiPath Associate, Blue Prism Developer.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-6 py-20 text-black ">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-white">
            Become a Certified RPA Professional
          </h2>
          <p className="text-lg md:text-xl text-white mb-6">
            Learn UiPath, Blue Prism, Automation Anywhere, Process Design, Bot Development & Deployment with real-time
            projects and job-focused training.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>✓ Beginner → Advanced modules</li>
                <li>✓ Real-time automation projects</li>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["UiPath", "Automation Anywhere", "Blue Prism", "Power Automate", "Bot Studio", "Orchestrator", "Task Capture", "RPA Recorder"].map(
                  (tool) => (
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["RPA Basics", "Bot Creation", "Workflow Design", "Exception Handling", "Data Scraping", "Deployment & Orchestration"].map(
                  (topic) => (
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>Design, build & deploy bots</li>
                <li>Automate repetitive business tasks</li>
                <li>Handle exceptions & complex flows</li>
                <li>Manage bot lifecycle with orchestrators</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Master RPA with structured modules covering UiPath, Blue Prism, Automation Anywhere, Power Automate & Orchestrator.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Build end-to-end automation: invoice processing, email parsing, data scraping & attended/unattended bots.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div>
                  <input
                    type="text"
                    name="course"
                    placeholder="Type Course (e.g., RPA)"
                    value={form.course}
                    onChange={handleChange}
                    onBlur={handleBlur}
