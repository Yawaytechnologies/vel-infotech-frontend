...
export default function JavaCoursePage() {
  ...
  const courseJsonLd = {
    ...
    "@type": "Course",
    name: "RPA (Robotic Process Automation) course",
    description:
      "Learn RPA from industry experts and automate business processes with UiPath, Blue Prism & Automation Anywhere. Build a high-demand career in automation today!",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      url: "https://www.vellinfotech.com/all-courses/all-courses/rpa-robotic-process-automation-course",
    },
    hasCourseInstance: {
      "@type": "CourseInstance",
  ...
  const courses = [
    ...
    {
      title: "AwsTraining",
      image: "https://cdn-icons-png.flaticon.com/512/11518/11518934.png",
    },
    {
      title: "DevOps",
    ...
    },
    {
      ...
      image: "https://cdn-icons-png.flaticon.com/512/4828/4828804.png",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="w-full pt-32 bg-gradient-to-r from-[#005BAC] to-[#003c6a] text-white px-4 py-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
                ✅ Enroll in the <strong>Top RPA Training Institute</strong> to
                build a rewarding career in automation and digital workforce
                technology.
              </li>
              <li>
                ✅ Learn core tools –{" "}
              ...
              <li>
                ...
                <strong>
                  real-time projects, bot development & business process
                  automation
                </strong>
                .
              </li>
              <li>
                ✅ Master{" "}
                <strong>
                  workflow design, data scraping, exception handling &
                  orchestrators
                </strong>
                .
              </li>
              <li>
                ✅ Earn <strong>RPA Certifications</strong> like UiPath
                Associate or Blue Prism Developer.
              </li>
              <li>
            ...
            >
              <div>
                ...
                <span className="text-sm text-gray-300">
                  | RPA Training | Duration: 3 Months
                </span>
              </div>
            </button>
          </div>
        ...
        <div className="w-full mt-12 bg-[#1e88e5] py-5 rounded-md shadow-md">
          <p className="text-center text-white font-bold text-xl md:text-2xl">
            Offering <strong>Online and Offline RPA Training</strong> in
          ...
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> RPA
                fundamentals, benefits & use cases.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Automating
                processes with UiPath, Blue Prism & Automation Anywhere.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Bots, control
                flow, selectors & exception handling.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Orchestrators,
                triggers & reusable components.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Certification
                prep: UiPath Associate, Blue Prism Developer.
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* ==================== CTA + CARDS ==================== */}
      <section className="w-full px-6 py-20 text-black bg-transparent">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-[#ffffff]">
            Become a Certified RPA Professional
          </h2>
          <p className="text-lg md:text-xl text-white mb-6">
            Learn UiPath, Blue Prism, Automation Anywhere, Process Design, Bot
            Development & Deployment with real-time projects and job-focused
            training.
          </p>
