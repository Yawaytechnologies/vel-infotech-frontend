  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        <li>✅ Enroll in the <strong>Top RPA Training Institute</strong> to build a rewarding career in automation and digital workforce technology.</li>
        <li>✅ Learn core tools – <strong>UiPath, Automation Anywhere, Blue Prism, Power Automate, and RPA Bots</strong>.</li>
        <li>✅ Build hands-on experience through <strong>real-time projects, bot development, and business process automation</strong>.</li>
        <li>✅ Gain deep understanding of <strong>workflow design, data scraping, exception handling, and orchestrators</strong>.</li>
        <li>✅ Earn globally recognized <strong>RPA Certifications</strong> like UiPath Certified RPA Associate or Blue Prism Developer.</li>
        <li>✅ Career support: Live projects, resume preparation, mock interviews & job placement assistance.</li>
      </ul>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our RPA Training Program is designed to help you master automation tools and processes that transform manual workflows into efficient, scalable bots. You'll gain hands-on experience in platforms like UiPath, Automation Anywhere, and Blue Prism to become a certified RPA professional.
      </p>

      {/* What You’ll Learn */}
      <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
        What You’ll Learn From RPA Training
      </h3>
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Understand RPA fundamentals, benefits, and real-world applications.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Learn to automate business processes using UiPath, Blue Prism, and Automation Anywhere.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Work with bots, workflows, control flow, selectors, and exception handling.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Build scalable bots using reusable components, orchestrators, and triggers.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Prepare for RPA certifications like UiPath Certified RPA Associate or Blue Prism Developer.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Get career support with resume building, interview prep, and placement assistance.
        </li>
      </ul>
    </div>
  </div>
...
<section className="w-full px-6 py-20 bg-gradient-to-b from-[#] to-[#] text-black">
  ...
  <div className="max-w-7xl mx-auto text-center mb-16">
    <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-white">
      Become a Certified RPA (Robotic Process Automation) Professional
    </h2>
    <p className="text-lg md:text-xl text-white mb-6">
      Learn UiPath, Blue Prism, Automation Anywhere, Process Design, Bot Development, and Deployment with real-time projects and career-focused training.
    </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          <li>✓ Beginner to Advanced RPA Modules</li>
          <li>✓ Real-time automation project implementation</li>
          <li>✓ Resume prep & mock interviews</li>
          <li>✓ Certification & job placement support</li>
        </ul>
      </div>
    </div>
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["UiPath", "Automation Anywhere", "Blue Prism", "Power Automate", "Bot Studio", "Orchestrator", "Task Capture", "RPA Recorder"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["RPA Basics", "Bot Creation", "Workflow Design", "Exception Handling", "Data Scraping", "Deployment & Orchestration"].map((topic, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          <li>Design, build, and deploy RPA bots</li>
          <li>Automate repetitive business tasks</li>
          <li>Handle exceptions and complex workflows</li>
          <li>Work with orchestrators and manage bot lifecycle</li>
        </ul>
      </div>
    </div>
