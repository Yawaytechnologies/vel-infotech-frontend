...
export default function ScrumMaster() {
  ...
  const courseJsonLd = {
    ...
    description:
      "Learn product strategy, roadmap planning, and market research. Gain skills to manage products from ideation to launch and drive business growth effectively.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
    ...
    hover:border-rose-300 hover:before:right-12 hover:before:-bottom-8 hover:before:blur hover:after:-right-8"
        ...
        <div className="w-full mt-12 bg-[#1e88e5] py-5 rounded-md shadow-md">
          <h2 className="text-center text-white font-bold text-xl md:text-2xl">
            Offering{" "}
            <strong>Online and Offline Product Management Training</strong> in
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                Become job-ready as a Product Manager. Learn how to define
                product vision, build roadmaps, conduct market research,
                collaborate with cross-functional teams, and drive successful
                product launches. Prepare for global certifications like{" "}
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Market
                  research, user personas, competitive analysis & positioning.
                </li>
                <li className="flex items-start gap-3">
        ...
        <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-white mb-6">
              Master product strategy, roadmapping, market research &
              go-to-market execution with hands-on practice.
            </p>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  ...
                  prioritization (MoSCoW, RICE, WSJF), and go-to-market
                  planning.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  ...
                  Associate PM, Product Manager, or Product Owner.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  ...
                  design go-to-market strategies, and analyze KPIs with
