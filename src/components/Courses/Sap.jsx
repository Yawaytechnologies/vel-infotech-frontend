...
export default function JavaCoursePage() {
  ...
  const courseJsonLd = {
    ...
    "@type": "Course",
    name: "SAP Training Program",
    description:
      "Learn SAP modules, ERP processes, and business workflows. Gain hands-on skills to manage enterprise operations and boost career opportunities in SAP.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
                ✅ Get ready for <strong>SAP certification</strong> and
                consultant roles.
              </li>
              <li>
