      ...
      <section className="w-full pt-32 bg-gradient-to-r from-[#005BAC] to-[#003c6a] text-white px-4 py-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <li>
  ✅ Join the <strong>Best AWS Solutions Architect Training Institute</strong> to master
  cloud architecture, design patterns, and end-to-end AWS solutions.
</li>
<li>
  ✅ Learn <strong>AWS EC2, S3, VPC, RDS, Lambda, CloudFront, Route 53, IAM, CloudFormation, Auto Scaling, ELB</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world AWS architecture projects</strong> with hands-on labs and case studies.
</li>
<li>
...
<li>
  ...
  <strong>AWS Solutions Architect Certification</strong>.
</li>
<li>
  ...
  Become a AWS Solutions Architect in 2–3 Months
</p>
  ...
  Overview of AWS Solutions Architect Training Course
</h2>
<div className="w-28 h-1 bg-orange-600 mx-auto mb-8 rounded-full"></div>

{/* Description */}
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our AWS Solutions Architect Training equips you with the skills and hands-on expertise
  required to design, deploy, and manage scalable, secure, and cost-optimized cloud solutions.
  This course covers AWS EC2, S3, VPC, RDS, Lambda, CloudFront, Route 53, IAM, CloudFormation,
  Auto Scaling, and ELB. You’ll also work on real-world AWS architecture projects,
  implement end-to-end cloud solutions, and receive interview preparation support to
  kick-start your career in cloud architecture and solution design.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From AWS Solutions Architect Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in AWS cloud architecture, design principles, and best practices.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to design and deploy highly available, fault-tolerant, and cost-optimized cloud solutions.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in compute, storage, networking, security, and database services on AWS.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world AWS architecture projects including multi-tier applications and serverless solutions.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build practical solutions incorporating monitoring, automation, and cost optimization using AWS services.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master AWS Solutions Architecture with structured modules covering EC2, S3, VPC, RDS, Lambda, CloudFront, Route 53, IAM, CloudFormation, Auto Scaling, ELB, Serverless Architectures, Security, Monitoring, Cost Optimization, and more.
</p>
