  ...
  export default function OraclePlSqlPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.oraclePlSql;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
             ...
             <li>
  ✅ Join the <strong>Best Oracle PL/SQL Training Institute</strong> to master
  procedural programming and database automation.
</li>
<li>
  ✅ Learn <strong>PL/SQL Blocks, Cursors, Stored Procedures, Functions, Packages, Triggers, Exception Handling</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world datasets & case studies</strong> with hands-on
  database automation and PL/SQL projects.
</li>
<li>
...
<li>
  ...
  <strong>Oracle PL/SQL Certification</strong>.
</li>
<li>
  ...
  placement assistance.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Oracle PLSQL expert in 3 Months
            </p>
  ...
  Our Oracle PL/SQL Training equips you with the skills and hands-on expertise
  required to become an industry-ready database developer. This course covers
  PL/SQL fundamentals, Cursors, Stored Procedures, Functions, Packages, Triggers,
  Exception Handling, and Dynamic SQL. You’ll also work on real-world projects,
  automate database workflows, and receive interview preparation support to
  kick-start your career in database programming and administration.
</p>
  ...
  What You’ll Learn From Oracle PL/SQL Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in procedural database programming and Oracle PL/SQL architecture.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to create and manage PL/SQL blocks, cursors, procedures, functions, and packages.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in exception handling, triggers, and dynamic SQL for automation and advanced workflows.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work with advanced PL/SQL features like bulk processing, collections, and modular programming.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build real-world projects including automated workflows, reporting, and database optimization.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Oracle PL/SQL with structured modules covering PL/SQL blocks, Cursors, Stored Procedures, Functions, Packages, Triggers, Exception Handling, Dynamic SQL, and more.
</p>
