  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        <li>✅ Enroll in the <strong>Top DevOps Training Institute</strong> to master CI/CD and automation workflows.</li>
        <li>✅ Learn essential tools – <strong>Git, Jenkins, Docker, Kubernetes, Ansible, Terraform, AWS, Prometheus</strong>.</li>
        <li>✅ Build practical skills through <strong>hands-on pipelines, container orchestration, and automation scripts</strong>.</li>
        <li>✅ Get deep insights into <strong>infrastructure as code (IaC), continuous integration, and monitoring</strong>.</li>
        <li>✅ Earn a globally recognized <strong>DevOps Certification</strong>.</li>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our AWS Training program is designed to help you build expertise in Amazon Web Services, the leading cloud platform. You'll learn key services like EC2, S3, Lambda, IAM, VPC, and RDS through real-world use cases and hands-on labs. Perfect for those aiming for cloud certifications and cloud-based career roles.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        ...
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Get career support with resume writing, certification prep, and placement help.
        </li>
      </ul>
    </div>
  </div>
...
<section className="w-full px-6 py-20 bg-gradient-to-b from-[#] to-[#] text-black">
  ...
  <div className="max-w-7xl mx-auto text-center mb-16">
    ...
    <p className="text-lg md:text-xl text-white mb-6">
      Learn AWS Compute, Storage, Networking, IAM, Serverless, DevOps Tools, and prepare for AWS Certification with real-world labs.
    </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["EC2", "S3", "Lambda", "VPC", "IAM", "CloudWatch", "RDS", "CloudFormation"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Cloud Basics", "AWS IAM & Policies", "Networking in AWS", "Compute & Storage", "Serverless", "Monitoring & Security"].map((topic, i) => (
