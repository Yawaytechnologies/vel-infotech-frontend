  ...
  export default function TypescriptTestingPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.typescriptTesting;
  ...
  <span className="text-yellow-400">
    TypeScript Testing Course
  </span>
</h2>

<ul className="space-y-3 mt-6 text-lg">
  <li>
    ✅ Join the <strong>Best TypeScript Testing Training Institute</strong> to master
    unit, integration, and end-to-end testing with TypeScript.
  </li>
  <li>
    ✅ Learn <strong>TypeScript Testing Fundamentals, Jest & Mocha, API Testing, 
    End-to-End Testing with Cypress/Playwright, Mocking & Stubbing, 
    TDD/BDD, Automation Framework Design, Reporting, and CI/CD Integration</strong>.
  </li>
  <li>
    ✅ Work on <strong>real-world TypeScript testing projects</strong> including 
    full-stack applications, REST & GraphQL APIs, and enterprise-level test automation frameworks.
  </li>
  <li>
    ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
  </li>
  <li>
    ✅ Earn an industry-recognized <strong>TypeScript Testing Certification</strong>.
  </li>
  <li>
  ...
  Become an expert TypeScript Tester in 2–3 Months
</p>
  ...
  Overview of TypeScript Testing Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our TypeScript Testing Training equips you with the skills and hands-on expertise
  required to design, write, and execute robust automated tests for modern applications. 
  This course covers TypeScript Fundamentals, Unit & Integration Testing with Jest/Mocha, 
  End-to-End Testing with Cypress & Playwright, API Testing, Mocking & Stubbing, 
  Test-Driven Development (TDD), Behavior-Driven Development (BDD), Reporting, 
  and CI/CD Integration. You’ll also work on real-world TypeScript testing projects,
  build scalable automation frameworks, and receive interview preparation
  support to kick-start your career in test automation and quality engineering.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From TypeScript Testing Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in TypeScript language features, testing principles, and automation concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to write and execute unit, integration, and end-to-end tests using Jest, Mocha, Cypress, and Playwright.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in mocking, stubbing, assertions, and handling async operations in TypeScript tests.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world TypeScript testing projects including full-stack apps, APIs, and enterprise test frameworks.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Implement TypeScript test automation with CI/CD tools like Jenkins, GitHub Actions, or GitLab for continuous testing.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master TypeScript Testing with structured modules covering TypeScript Fundamentals, 
  Unit & Integration Testing with Jest/Mocha, End-to-End Testing with Cypress & Playwright, 
  API Testing, Mocking & Stubbing, Test-Driven Development (TDD), Behavior-Driven Development (BDD), 
  Assertions & Debugging, Reporting & Coverage, CI/CD Integration, and more.
</p>
