...
export default function JavaCoursePage() {
  ...
  const courseJsonLd = {
    ...
    description:
      "Learn cybersecurity fundamentals, ethical hacking, and threat protection. Gain hands-on skills to secure networks, systems, and data from cyber threats.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
                ✅ Learn core topics –{" "}
                <strong>
                  Network Security, Ethical Hacking, Firewalls, Malware
              ...
              <li>
                ...
                <strong>
                  real-time threat simulations, vulnerability scanning, and risk
                  assessment labs
                </strong>
                .
              </li>
              <li>
                ...
                <strong>
                  penetration testing, SOC operations, and incident response
                  strategies
                </strong>
                .
              </li>
              <li>
                ...
                <strong>Cyber Security Certification</strong> like CEH or
                CompTIA Security+.
              </li>
              <li>
            ...
            >
              <div>
                ...
                <span className="text-sm text-gray-300">
                  | Cyber Security | Duration: 3 Months
                </span>
              </div>
            </button>
          </div>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                Our Cyber Security Training program is designed to equip you
                with the skills to defend digital systems and networks from
                threats. Learn ethical hacking, vulnerability assessment, and
                security best practices to prepare for roles like Security
                Analyst, Penetration Tester, or SOC Engineer.
              </p>
        ...
        >
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-white mb-6">
              Learn Ethical Hacking, Vulnerability Assessment, Network Defense,
              Security Tools, and Incident Handling with real-time labs and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            >
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                  ...
                  <li>
                    ✓ Real-time practical attack &amp; defense simulations
                  </li>
            ...
            >
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                  <li>
                    Identify &amp; mitigate cyber threats and vulnerabilities
                  </li>
            ...
            <div className="space-y-4">
              <details className="group border border-gray-200 rounded-xl bg-[#f9fbff] p-5">
                ...
                <p className="mt-3 text-gray-700">
                  Yes. We start with cybersecurity and networking basics, then
                  move into ethical hacking, SOC workflows, and incident
                  response.
                </p>
              </details>
              ...
              <details className="group border border-gray-200 rounded-xl bg-[#f9fbff] p-5">
                ...
                <p className="mt-3 text-gray-700">
                  Yes. You’ll simulate attacks/defense, perform vulnerability
                  scans, analyze logs, and complete a SOC-style capstone.
                </p>
              </details>
