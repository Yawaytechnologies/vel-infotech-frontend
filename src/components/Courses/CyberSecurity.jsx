...
export default function JavaCoursePage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Cyber Security Enquiry:", form);
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Enroll in the <strong>Top Cyber Security Institute</strong> to
              launch your career in ethical hacking and information security.
            </li>
            <li>
              ✅ Learn core topics –{" "}
              <strong>
                Network Security, Ethical Hacking, Firewalls, Malware Analysis,
                Cryptography
              </strong>
              .
            </li>
            ...
            <li>
              ...
              <strong>Cyber Security Certification</strong> like CEH or CompTIA
              Security+.
            </li>
            <li>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Our Cyber Security Training program is designed to equip you with
              the skills to defend digital systems and networks from threats.
              Learn ethical hacking, vulnerability assessment, and security best
              practices to prepare for roles like Security Analyst, Penetration
              Tester, or SOC Engineer.
            </p>
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
                Get career support with resume building, certification prep, and
                placement assistance.
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-stretch gap-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Simulate attacks & defense, analyze logs, and deliver SOC-style
                capstones.
              </p>
            </div>
          </div>
