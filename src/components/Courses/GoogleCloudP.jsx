  ...
  export default function GoogleCloudPlatformPage() {
    ...
    const course = SYLLABI.gcplatform;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              Google Cloud Platform Training Course
              </span>
            ...
            <li>
  ✅ Join the <strong>Best Google Cloud Platform (GCP) Training Institute</strong> to master
  cloud architecture, design patterns, and end-to-end GCP solutions.
</li>
<li>
  ✅ Learn <strong>Compute Engine, App Engine, Cloud Storage, Cloud SQL, BigQuery, VPC, IAM, Cloud Functions, Cloud Run, Cloud Load Balancing, Cloud Monitoring</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world GCP architecture projects</strong> with hands-on labs and case studies.
</li>
<li>
...
<li>
  ...
  <strong>Google Cloud Solutions Architect Certification</strong>.
</li>
<li>
  ...
  Become a Google Cloud Platform expert in 2–3 Months
</p>
  ...
  Overview of Google Cloud Platform (GCP) Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our GCP Training equips you with the skills and hands-on expertise
  required to design, deploy, and manage scalable, secure, and cost-optimized cloud solutions.
  This course covers Compute Engine, App Engine, Cloud Storage, Cloud SQL, BigQuery, VPC, IAM,
  Cloud Functions, Cloud Run, Cloud Load Balancing, and Monitoring. You’ll also work on real-world
  GCP architecture projects, implement end-to-end cloud solutions, and receive interview preparation
  support to kick-start your career in cloud architecture and solution design.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From GCP Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in GCP cloud architecture, design principles, and best practices.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to design and deploy highly available, fault-tolerant, and cost-optimized cloud solutions on GCP.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in compute, storage, networking, security, and database services on GCP.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world GCP architecture projects including multi-tier applications and serverless solutions.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build practical solutions incorporating monitoring, automation, and cost optimization using GCP services.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Google Cloud Solutions Architecture with structured modules covering Compute Engine, App Engine, Cloud Storage, Cloud SQL, BigQuery, VPC, IAM, Cloud Functions, Cloud Run, Cloud Load Balancing, Serverless Architectures, Security, Monitoring, Cost Optimization, and more.
</p>
