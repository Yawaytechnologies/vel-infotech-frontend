...
export default function JavaCoursePage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Hardware & Networking Enquiry:", form);
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Enroll in the{" "}
              <strong>Top Hardware &amp; Networking Institute</strong> to build
              a solid career in IT infrastructure.
            </li>
            <li>
              ✅ Learn core topics –{" "}
              <strong>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
                Build, configure, and secure LAN/WAN networks using routers and
                switches.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span>
                Get career support with resume building, interview prep, and job
