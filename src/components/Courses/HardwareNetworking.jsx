...
export default function JavaCoursePage() {
  ...
  const course = SYLLABI.hardwarenetworking;
  ...
  const courseJsonLd = {
    ...
    "@type": "Course",
    name: "Hardware & Networking Program",
    description:
      "Learn computer hardware, networking concepts, and troubleshooting. Gain hands-on skills to set up, maintain, and manage IT infrastructure effectively.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      ...
      <section className="w-full pt-32 bg-gradient-to-r from-[#005BAC] to-[#003c6a] text-white px-4 py-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
                ...
                build a solid career in IT infrastructure.
              </li>
              <li>
                ✅ Learn core topics –{" "}
                <strong>
                  Computer Hardware, Networking, LAN/WAN, Routers, Switches, IP
                  Addressing
                </strong>
                .
              </li>
              <li>
                ...
                <strong>
                  system assembly, network configuration, and troubleshooting
                </strong>
                .
              </li>
              <li>
                ...
                <strong>
                  network security, server management, and remote support tools
                </strong>
                .
              </li>
              <li>
                ✅ Earn a globally recognized{" "}
                <strong>Hardware &amp; Networking Certification</strong>.
              </li>
              <li>
            ...
            >
              <div>
                ...
                <span className="text-sm text-gray-300">
                  | Hardware &amp; Networking | Duration: 3 Months
                </span>
              </div>
            </button>
          </div>
          ...
          >
            ...
            <p className="mb-4 text-lg">
              Become a Hardware &amp; Networking Specialist in Just 3 Months
            </p>
        ...
        >
          <p className="text-center text-white font-bold text-xl md:text-2xl">
            Offering{" "}
            <strong>
              Online and Offline Hardware &amp; Networking Training
            </strong>{" "}
            in
            ...
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Understand computer hardware components and system
                  architecture.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Build, configure, and secure LAN/WAN networks using routers
                  and switches.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Gain expertise in IP addressing, DHCP, DNS, and network
                  troubleshooting.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Learn about firewalls, network security, and antivirus
                  solutions.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span>
                  Get career support with resume building, interview prep, and
        ...
        >
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-white mb-6">
              Learn Computer Hardware, Network Setup, IP Configuration, Security
              Tools, and Troubleshooting with real-time practice and job-ready
              skills.
            </p>
            ...
            <div className="space-y-4">
              <details className="group border border-gray-200 rounded-xl bg-[#f9fbff] p-5">
                ...
                <p className="mt-3 text-gray-700">
                  Yes. We start from hardware and networking fundamentals, then
                  move to LAN/WAN, routing/switching, IP configuration and
                  security.
                </p>
              </details>
              ...
              <details className="group border border-gray-200 rounded-xl bg-[#f9fbff] p-5">
                ...
                <p className="mt-3 text-gray-700">
                  Yes. You’ll work on guided labs: system assembly, network
                  configuration, routing/switching practice, and security
                  hardening.
                </p>
              </details>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  Master Hardware &amp; Networking with modules on PC Assembly,
                  LAN/WAN, Routing, Switching, IP and Security.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  Build and troubleshoot real lab networks, configure
                  routers/switches &amp; secure endpoints.
                </p>
              </div>
            </div>
