        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
  ✅ Join the <strong>Best VMware Training Institute</strong> to master
  virtualization and cloud infrastructure.
</li>
<li>
  ✅ Learn <strong>VMware vSphere, ESXi, vCenter, Networking, Storage, HA/DRS</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world labs & case studies</strong> with hands-on
...
<li>
  ...
  <strong>VMware Certification</strong>.
</li>
<li>
  ...
  placement assistance.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Vmware expert in 3 Months
            </p>
  ...
  Our VMware Training equips you with the knowledge and hands-on expertise
  required to become an industry-ready virtualization professional. This
  course covers VMware vSphere, ESXi, vCenter, Networking, Storage, HA/DRS,
  and more. You’ll also work on real-world labs, practice deployment and
  migration scenarios, and receive interview preparation support to
  kick-start your career in VMware and cloud infrastructure management.
</p>
  ...
  What You’ll Learn From Vmware Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build a strong foundation in virtualization concepts and VMware vSphere architecture.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Learn to install, configure, and manage VMware ESXi hosts and virtual machines.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Gain expertise in vCenter Server for centralized management and monitoring.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Configure VMware networking, storage, and resource management effectively.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Work on real-world labs and projects including HA, DRS, vMotion, and disaster recovery scenarios.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  ...
  Master VMware with structured modules covering vSphere, ESXi, vCenter, Networking, Storage, HA/DRS, and more.
</p>
