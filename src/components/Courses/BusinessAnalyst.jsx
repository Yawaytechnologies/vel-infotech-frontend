...
e.preventDefault();
// run your existing validation first; if ok:
const payload = {
name: form.name.trim(),
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Learn the <strong>fundamentals of Business Analysis</strong>{" "}
              from industry experts.
            </li>
            <li>
              ✅ Master key practices –{" "}
              <strong>
                Requirement Gathering, BRD/FRD Documentation, Process Modeling,
                Gap Analysis
              </strong>
              .
            </li>
            <li>
              ✅ Get hands-on with{" "}
              <strong>Jira, Confluence, MS Visio, Tableau, Excel, SQL</strong>.
            </li>
            <li>
              ✅ Build real-world skills in{" "}
              <strong>
                stakeholder communication, user stories, wireframing, UAT
                planning & agile/scrum practices
              </strong>
              .
            </li>
            <li>
              ✅ Prepare for global certifications like{" "}
              <strong>CBAP, CCBA, ECBA (IIBA)</strong>.
            </li>
            <li>
              ✅ Career support:{" "}
              <strong>
                Mock interviews, resume prep, case study practice & placement
                assistance
              </strong>
              .
            </li>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Become job-ready as a Business Analyst. Learn how to gather
              requirements, analyze processes, create documentation, design
              workflows, and collaborate with stakeholders to deliver business
              value. Prepare for global certifications like{" "}
              <span className="font-semibold">ECBA / CCBA / CBAP (IIBA)</span>{" "}
              with real-world case studies and hands-on projects.
            </p>

            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
              What You’ll Learn From Business Analyst Training
            </h3>
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Fundamentals of
                Business Analysis, SDLC & Agile/Scrum frameworks.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Requirement
                elicitation, BRD/FRD documentation, and use case modeling.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Tools for BA:
                Jira, Confluence, MS Visio, SQL, Tableau, Excel.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Stakeholder
                management, communication, and workshop facilitation.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> Process flows,
                wireframes, mockups, and user stories creation.
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-600 mt-1">➤</span> UAT planning,
                test case validation & change management techniques.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-white mb-6">
            Master requirements gathering, process modeling, stakeholder
            communication & Agile practices with real-world case studies.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>✓ End-to-end Business Analysis training</li>
                <li>✓ Certification prep: ECBA / CCBA / CBAP</li>
                <li>✓ Real-world case studies & live projects</li>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>Elicit and document business requirements</li>
                <li>Create BRDs, FRDs, use cases & wireframes</li>
                <li>Analyze processes & identify gaps</li>
                <li>Facilitate UAT & support stakeholders</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Business analysis fundamentals, requirement elicitation, BRD/FRD
                documentation, process modeling (UML, BPMN), user stories, gap
                analysis, and Agile/Scrum practices for BAs.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                ECBA / CCBA / CBAP certification prep, real-world case studies,
                mock interviews, resume & LinkedIn optimization, and practical
                scenarios for stakeholder communication.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                ...
                Analyst, and Product Owner positions.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                ...
                Excel, and conduct UAT with real-world business case projects.
              </p>
            </div>
          </div>
