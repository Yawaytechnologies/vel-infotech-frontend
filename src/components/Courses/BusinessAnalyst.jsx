...
export default function ScrumMaster() {
  ...
  const courseJsonLd = {
    ...
    description:
      "Join our Business Analyst Program to master data analysis, documentation, and tools like Excel, SQL & Power BI. Get certified and become job-ready in 3 months!",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
                ...
                <strong>
                  Requirement Gathering, BRD/FRD Documentation, Process
            ...
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Fundamentals
                  of Business Analysis, SDLC & Agile/Scrum frameworks.
                </li>
                <li className="flex items-start gap-3">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  ...
                  stories, gap analysis, and Agile/Scrum practices for BAs.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  ...
                  practical scenarios for stakeholder communication.
                </p>
              </div>
