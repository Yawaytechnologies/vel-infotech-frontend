  ...
  export default function PerformanceTuningPage() {
    ...
    const course = SYLLABI.performanceTuning;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              Performance Tuning Training Course
              </span>
            ...
            <ul className="space-y-3 mt-6 text-lg">
             ...
             <li>
  ✅ Join the <strong>Best Performance Tuning Training Institute</strong> to master
  system, application, and database optimization.
</li>
<li>
  ✅ Learn <strong>Query Optimization, Indexing & Partitioning, Caching, Memory Management, Load Testing, Benchmarking, Profiling Tools, and Performance Troubleshooting</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world performance tuning projects</strong> with hands-on labs and case studies.
</li>
<li>
...
<li>
  ...
  <strong>Performance Tuning Certification</strong>.
</li>
<li>
  ...
  Become a Performance Tuning expert in 2–3 Months
</p>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
                Overview of Performance Tuning Training Course
              </h2>
  ...
  Our Performance Tuning Training equips you with the skills and hands-on expertise
  required to optimize databases, applications, and IT systems for peak performance. 
  This course covers Query Optimization, Indexing & Partitioning, Caching, Memory Management, 
  Load Testing, Benchmarking, Profiling Tools, and Performance Troubleshooting. 
  You’ll also work on real-world performance tuning projects, implement end-to-end optimizations, 
  and receive interview preparation support to kick-start your career in system and database performance management.
</p>
  ...
  What You’ll Learn From Performance Tuning Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build a strong foundation in performance tuning concepts for databases, applications, and IT systems.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Learn to analyze system architecture, monitor resources, and optimize database and application performance.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Gain expertise in query optimization, indexing, caching, memory management, and load testing.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Work on real-world performance tuning projects, benchmarking, and high-availability solutions.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build real-world projects including end-to-end optimizations, monitoring, and troubleshooting.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Performance Tuning with structured modules covering Query Optimization, Indexing & Partitioning, Caching, Memory Management, Load Testing, Benchmarking, Profiling Tools, Application & Database Performance, Troubleshooting, and more.
</p>
