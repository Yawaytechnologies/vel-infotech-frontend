...
export default function SoftSkillPage() {
  ...
  const courseJsonLd = {
    ...
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      url: "https://www.velinfotech.com/all-courses/soft-skills-training",
    },
    hasCourseInstance: {
      "@type": "CourseInstance",
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                ...
                interviews, group discussions, and on-the-job situations.
                Develop interpersonal and communication skills needed to thrive
                in today's workplace and become a high-impact professional.
              </p>
        ...
        <section className="w-full px-6 py-20  text-white">
          ...
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl mb-6">
              Master communication, teamwork, leadership, and presentation
