...
export default function SoftSkillPage() {
  ...
  const course = SYLLABI.softskills;
  ...
  const [form, setForm] = useState({
    ...
    email: "",
    phone: "",
    course: "Soft Skill Training", // prefill for this page
    message: "",
  });
  ...
  const courseJsonLd = {
    ...
    description:
      "Boost your career with our Soft Skills Training. Learn communication, teamwork, leadership & presentation skills to succeed in any professional role!",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      url: "https://www.vellinfotech.com/all-courses/soft-skills-training",
    },
    hasCourseInstance: {
      "@type": "CourseInstance",
      ...
      <section className="w-full pt-32 bg-gradient-to-r from-[#005BAC] to-[#003c6a] text-white px-4 py-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
                ✅ Develop{" "}
                <strong>
                  professional communication, confidence, and emotional
                  intelligence
                </strong>
                .
              </li>
              <li>
                ✅ Master{" "}
                <strong>
                  presentation, public speaking, teamwork, and leadership
                </strong>{" "}
                skills.
              </li>
              <li>
              ...
              <li>
                ...
                <strong>Soft Skill Certification</strong>.
              </li>
              <li>
                ✅ Career support: Resume building, LinkedIn branding, and
                placement guidance.
              </li>
            </ul>
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            <h2 className="text-2xl font-bold mb-4">STAND OUT AT WORK!</h2>
            <p className="mb-4 text-lg">
              Enhance Your Soft Skills and Grow Your Career
            </p>
        ...
        <div className="w-full mt-12 bg-[#1e88e5] py-5 rounded-md shadow-md">
          <p className="text-center text-white font-bold text-xl md:text-2xl">
            Offering <strong>Online and Offline Soft Skills Training</strong> in
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Our Soft Skills Training is designed to help you succeed in
              interviews, group discussions, and on-the-job situations. Develop
              interpersonal and communication skills needed to thrive in today's
              workplace and become a high-impact professional.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              <img
                ...
                className="w-10 h-10 mb-4"
              />
              <h3 className="text-lg font-extrabold mb-2">Key Benefits</h3>
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
