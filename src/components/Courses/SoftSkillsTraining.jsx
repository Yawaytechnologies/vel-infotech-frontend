...
export default function SoftSkillPage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Soft Skills Enquiry:", { ...form, mode });
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Develop{" "}
              <strong>
                professional communication, confidence, and emotional intelligence
              </strong>
              .
            </li>
            <li>
              ✅ Master{" "}
              <strong>presentation, public speaking, teamwork, and leadership</strong>{" "}
              skills.
            </li>
            <li>
    ...
    {/* Course Partners Section */}
      ...
      {/* SYLLABUS */}
                              <Syllabus
                                            ...
                                            stickyOffset={110}
                                          />
      {/* ENQUIRY FORM SECTION (Validated) */}
      <section className="w-full px-6 py-20 text-white">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Participate in roleplays, presentations, and live GDs with
                individual feedback.
              </p>
            </div>
            {/* Box 2 */}
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Build your professional profile and get LinkedIn &amp; resume
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Get job referrals and connect with top recruiters in the IT and
                corporate sector.
              </p>
            </div>
            {/* Box 4 */}
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Mock interviews &amp; GD panels conducted by industry experts and
                HRs.
              </p>
            </div>
          </div>
