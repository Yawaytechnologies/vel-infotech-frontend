  ...
  export default function OracleSqlPage() {
    const [mode, setMode] = useState("classroom");
    const course = SYLLABI.oracleSql;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
             ...
             <li>
  ✅ Join the <strong>Best Oracle SQL Training Institute</strong> to master
  database querying and management.
</li>
<li>
  ✅ Learn <strong>Oracle SQL, DDL/DML/TCL, Joins, Subqueries, Views, Indexes, Functions, PL/SQL</strong> and more.
</li>
<li>
...
<li>
  ...
  <strong>Oracle SQL Certification</strong>.
</li>
<li>
  ...
  placement assistance.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Oracle SQL expert in 3 Months
            </p>
  ...
  Our Oracle SQL Training equips you with the knowledge and practical skills
  required to become an industry-ready database professional. This course
  covers SQL fundamentals, DDL, DML, TCL commands, Joins, Subqueries, Views,
  Indexes, Functions, and PL/SQL programming. You’ll also work on real-world
  database projects, optimize queries for performance, and receive interview
  preparation support to kick-start your career in database development and
  administration.
</p>
  ...
  What You’ll Learn From Oracle SQL Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build a strong foundation in relational database concepts and Oracle SQL architecture.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Learn to create and manage Oracle databases, tables, views, and indexes.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Gain expertise in writing SQL queries for data retrieval, filtering, joins, and subqueries.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Work with advanced SQL features like constraints, functions, triggers, and stored procedures.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  Build real-world projects including reporting, performance tuning, and database optimization.
</li>
<li className="flex items-start gap-3">
  <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Oracle SQL with structured modules covering SQL fundamentals, DDL/DML/TCL commands, Joins, Subqueries, Views, Indexes, Functions, PL/SQL, and more.
</p>
