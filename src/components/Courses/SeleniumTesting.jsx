      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-3 mt-6 text-lg">
            <li>
              ✅ Enroll in the <strong>Top Selenium Training Institute</strong> to become an automation testing expert.
            </li>
            <li>
              ✅ Master essential tools – <strong>Selenium WebDriver, Java, TestNG, Maven, Git, Jenkins</strong>.
            </li>
            <li>
              ✅ Get hands-on with <strong>real-time automation frameworks and test scripts</strong>.
            </li>
            <li>
              ✅ Learn industry practices for <strong>cross-browser, functional, and regression testing</strong>.
            </li>
            <li>
              ✅ Get certified with a recognized <strong>Selenium Automation Certification</strong>.
            </li>
            <li>
              ✅ Career support: Mock interviews, live projects, resume reviews & job placement assistance.
            </li>
          </ul>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Become job-ready in automation testing with Selenium WebDriver, Java, TestNG and CI/CD tooling (Maven, Jenkins, Git).
              Design robust frameworks (POM, data-driven) and automate real web apps end-to-end.
            </p>
            ...
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              ...
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> CI/CD with Maven, Jenkins & Git; cross-browser strategies.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Interview prep, resume polish & project portfolio.</li>
            </ul>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Selenium", "TestNG", "Java", "Maven", "Jenkins", "Git", "Postman", "Cucumber", "POM"].map((tool) => (
