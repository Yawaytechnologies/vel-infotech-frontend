...
import FeedbackWidget from "../common/Feedback";
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
                ✅ Learn core services –{" "}
                <strong>EC2, S3, Lambda, RDS, VPC, CloudWatch, IAM</strong>.
              </li>
              <li>
                ✅ Build practical skills through{" "}
                <strong>
                  hands-on labs, projects, and real-world use cases
                </strong>
                .
              </li>
              <li>
                ...
                <strong>
                  cloud architecture, deployment, security, and scalability
                </strong>
                .
              </li>
              <li>
                ✅ Earn a globally recognized <strong>AWS Certification</strong>
                .
              </li>
              <li>
