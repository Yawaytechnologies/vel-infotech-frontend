  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        <li>✅ Enroll in the <strong>Top AWS Training Institute</strong> to master cloud computing with AWS.</li>
        <li>✅ Learn core services – <strong>EC2, S3, Lambda, RDS, VPC, CloudWatch, IAM</strong>.</li>
        <li>✅ Build practical skills through <strong>hands-on labs, projects, and real-world use cases</strong>.</li>
        <li>✅ Get deep insights into <strong>cloud architecture, deployment, security, and scalability</strong>.</li>
        <li>✅ Earn a globally recognized <strong>AWS Certification</strong>.</li>
