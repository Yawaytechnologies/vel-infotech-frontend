  ...
  export default function OracleFusionPage() {
    ...
    const course = SYLLABI.oracleFusion;
      ...
      <section className="w-full pt-32 bg-gradient-to-r from-[#005BAC] to-[#003c6a] text-white px-4 py-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <li>
  ✅ Join the <strong>Best Oracle Fusion Training Institute</strong> to master
  cloud ERP, HCM, Financials, and SCM modules.
</li>
<li>
  ✅ Learn <strong>Oracle Fusion HCM, Financials, SCM, Setup & Configuration, Workflows, Reporting & Analytics, Integrations, and Extensions</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world Oracle Fusion projects</strong> with hands-on labs and case studies.
</li>
<li>
...
<li>
  ...
  <strong>Oracle Fusion Certification</strong>.
</li>
<li>
  ...
  Become a Oracle Fusion expert in 2–3 Months
</p>
  ...
  Overview of Oracle Fusion Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our Oracle Fusion Training equips you with the skills and hands-on expertise
  required to implement and manage cloud-based ERP solutions. This course covers
  Oracle Fusion HCM, Financials, SCM modules, Setup & Configuration, Workflows,
  Reporting & Analytics, and Integrations. You’ll also work on real-world Oracle
  Fusion projects, configure end-to-end processes, and receive interview preparation
  support to kick-start your career in cloud ERP and enterprise application management.
</p>
  ...
  What You’ll Learn From Oracle Fusion Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in Oracle Fusion architecture and cloud ERP concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to configure and manage HCM, Financials, and SCM modules effectively.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in workflows, reporting, analytics, and integration with other systems.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world Oracle Fusion projects including end-to-end process implementation.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build practical dashboards, reports, and automated workflows within Oracle Fusion.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Oracle Fusion with structured modules covering HCM, Financials, SCM, Setup & Configuration, Workflows, Reporting & Analytics, Integrations, Extensions, and more.
</p>
