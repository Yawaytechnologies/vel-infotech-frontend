        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              AWS Data Engineer Training Course
              </span>
            ...
            <li>
  ✅ Join the <strong>Best AWS Data Engineer Training Institute</strong> to master
  cloud data engineering, ETL pipelines, and analytics on AWS.
</li>
<li>
  ✅ Learn <strong>AWS S3, Redshift, RDS, DynamoDB, Glue, Kinesis, EMR, Lambda, Step Functions, and Data Security</strong> and more.
</li>
<li>
  ✅ Work on <strong>real-world AWS data engineering projects</strong> with hands-on labs and case studies.
</li>
<li>
...
<li>
  ...
  Become a AWS Data Engineer expert in 2–3 Months
</p>
  ...
  Overview of AWS Data Engineer Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our AWS Data Engineer Training equips you with the skills and hands-on expertise
  required to design, build, and manage cloud-based data solutions. This course covers
  AWS S3, Redshift, RDS, DynamoDB, Glue, Kinesis, EMR, Lambda, Step Functions, and Data Security.
  You’ll also work on real-world AWS data engineering projects, implement end-to-end data pipelines,
  and receive interview preparation support to kick-start your career in cloud data engineering and analytics.
</p>
  ...
  What You’ll Learn From AWS Data Engineer Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in AWS cloud architecture and data engineering concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to design, build, and manage ETL pipelines using AWS Glue, Lambda, and Step Functions.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in data storage, query optimization, and analytics using S3, Redshift, RDS, and DynamoDB.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world AWS data engineering projects including batch and streaming data pipelines.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build practical dashboards, reports, and analytics solutions integrated with AWS data services.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master AWS Data Engineering with structured modules covering S3, Redshift, RDS, DynamoDB, Glue, Kinesis, EMR, Lambda, Step Functions, Data Security, Data Warehousing, ETL, and more.
</p>
