        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
  ✅ Join the <strong>Best Microsoft Azure Training Institute</strong> to
  master Cloud Fundamentals & Advanced Azure Services.
</li>
<li>
  ✅ Learn <strong>Azure Administration, DevOps, Security, and Cloud
  Solutions</strong>.
</li>
<li>
  ✅ Build and deploy <strong>real-world cloud projects</strong> with hands-on
...
<li>
  ...
  <strong>Microsoft Azure Certification</strong>.
</li>
<li>
...
<li>
  ✅ Career support: Resume building, mock interviews & job referrals.
          ...
          <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
            ...
            <p className="mb-4 text-lg">
              Become a Azure Expert in 3 Months
            </p>
  ...
  Our Microsoft Azure Training equips you with the knowledge and
  hands-on experience required to become an industry-ready
  cloud professional. This course covers core Azure services such as
  Virtual Machines, Networking, Storage, Azure Active Directory, and
  advanced topics like Azure DevOps, Security, and Monitoring. You’ll
  also work on real-world cloud projects, practice deployment
  techniques, and receive interview preparation support to
  accelerate your career in cloud computing.
</p>


              {/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From Microsoft Azure Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Understand the fundamentals of Cloud Computing and Microsoft Azure core
    services such as Virtual Machines, Networking, and Storage.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn Azure Identity and Access Management with Azure Active Directory,
    Role-Based Access Control (RBAC), and Security best practices.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain hands-on experience with Azure App Services, Functions, Containers,
    and Kubernetes for modern application deployment.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Master CI/CD pipelines and Infrastructure as Code (IaC) using Azure
    DevOps, ARM templates, and Terraform.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world Azure projects including migration, monitoring, and
    optimization of cloud resources.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Get placement support with resume building, mock interviews, and
    certification guidance for Microsoft Azure exams.
  </li>
  ...
  Master Microsoft Azure with structured modules covering Cloud Fundamentals, 
  Virtual Machines, Networking, Security, DevOps, and more.
</p>
