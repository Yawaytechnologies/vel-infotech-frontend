  ...
  export default function PlaywrightTestingPage() {
    ...
    const course = SYLLABI.playwrightTesting;
...
<ul className="space-y-3 mt-6 text-lg">
 <li>
  ✅ Join the <strong>Best Playwright Testing Training Institute</strong> to master
  end-to-end, cross-browser, and API testing with Playwright.
</li>
<li>
  ✅ Learn <strong>Playwright Fundamentals, Selectors & Locators, UI Automation, 
  Cross-Browser Testing, API Testing, Network Interception, Advanced Playwright Features, 
  Test Automation Framework Design, Reporting, and CI/CD Integration</strong>.
</li>
<li>
  ✅ Work on <strong>real-world Playwright testing projects</strong> including 
  e-commerce, banking, SaaS, and enterprise-level web applications.
</li>
<li>
  ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
</li>
<li>
  ✅ Earn an industry-recognized <strong>Playwright Automation Testing Certification</strong>.
</li>
<li>
  ...
  Become an expert Playwright Tester in 2–3 Months
</p>
  ...
  Overview of Playwright Testing Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our Playwright Testing Training equips you with the skills and hands-on expertise
  required to perform fast, reliable, and scalable end-to-end testing for modern web applications. 
  This course covers Playwright Fundamentals, Locators & Selectors, UI Automation, 
  Cross-Browser Testing, API Testing, Network Interception, Advanced Playwright Features, 
  Test Automation Framework Design, Reporting, and CI/CD Integration. You’ll also work on 
  real-world Playwright testing projects, build reusable automation frameworks, and receive 
  interview preparation support to kick-start your career in test automation and quality engineering.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From Playwright Testing Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in Playwright framework, selectors, and test automation concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to automate functional, integration, and end-to-end tests across multiple browsers.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in Playwright features like assertions, fixtures, stubbing, mocking APIs, and handling async events.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world Playwright projects including e-commerce, banking, and enterprise-grade web apps.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Implement Playwright with CI/CD tools like Jenkins, GitHub Actions, or GitLab for continuous testing.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Playwright Testing with structured modules covering Playwright Fundamentals, 
  Locators & Selectors, UI Automation, Cross-Browser Testing, API Testing, Network Interception, 
  End-to-End Testing, Advanced Playwright Features, Test Automation Framework Design, 
