import React, { useState, useRef } from "react"; // eslint-disable-next-line no-unused-vars
...
export default function JavaCoursePage() {
  ...
  const courseJsonLd = {
    ...
    "@type": "Course",
    name: "Data Science & AI Program",
    description:
      "Learn Data Science and AI with Python, machine learning, and deep learning. Gain hands-on experience to solve real-world problems and build smart solutions.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
      url: "https://www.velinfotech.com/all-courses/data-science-and-ai-program",
    },
    hasCourseInstance: {
      "@type": "CourseInstance",
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              ...
              <li>
                ✅ Learn top technologies –{" "}
                <strong>
                  Python, Pandas, NumPy, Scikit-learn, TensorFlow, Power BI
                </strong>
                .
              </li>
              <li>
                ✅ Work on real-world AI projects with{" "}
                <strong>hands-on data modeling & ML pipelines</strong>.
              </li>
              <li>
              ...
              <li>
                ...
                <strong>Data Science & AI Certification</strong>.
              </li>
              <li>
            ...
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                ...
                <li className="flex items-start gap-3">
                  ...
                  insights with Power BI, Tableau & Python libs.
                </li>
                <li className="flex items-start gap-3">
        ...
        <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-white mb-6">
              Master Data Analysis, Machine Learning, Deep Learning, and AI with
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
                ...
                <p className="text-black/90">
                  Master DS & AI with modules covering Python, SQL, ML/DL,
                  Visualization, and MLOps basics.
                </p>
              </div>
