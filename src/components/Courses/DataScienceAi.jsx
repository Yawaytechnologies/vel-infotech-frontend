...
export default function DataScienceAi() {
  const audience = [
   "Non IT to IT", 
...
"Any Domain to IT Job" 
 ...
 const images = [
  ...
  const course = SYLLABI.datascienceai;
  /* ===========================
  ...
  const scrollToForm = () => {
    ...
    if (!el) return;
    const y = el.getBoundingClientRect().top + window.pageYOffset - 100; // offset for any fixed header
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Data Science & AI Enquiry:", form);
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
            ...
            <span className="text-yellow-400">Data Science & AI Program</span>
          </h2>

          <ul className="space-y-3 mt-6 text-lg">
            <li>✅ Join the <strong>Best Data Science Institute</strong> to master AI, ML, and analytics.</li>
            <li>✅ Learn top technologies – <strong>Python, Pandas, NumPy, Scikit-learn, TensorFlow, Power BI</strong>.</li>
            <li>✅ Work on real-world AI projects with <strong>hands-on data modeling & ML pipelines</strong>.</li>
            <li>✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.</li>
            <li>✅ Earn a globally recognized <strong>Data Science & AI Certification</strong>.</li>
        ...
        <div className="flex-1 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
          ...
          <p className="mb-4 text-lg">Become a Data Science & AI Expert in 3 Months</p>
        ...
        <div className="max-w-[100%] mx-auto px-4 md:px-10">
          <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-5">
              Overview of Data Science & AI Course
            </h2>
            ...
            <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
              Build expertise in data analysis, machine learning, deep learning, and AI using Python, Scikit-learn,
              TensorFlow, Pandas, NumPy and modern visualization tools. Learn by doing with real datasets and
              production-style projects.
            </p>

            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
              What You’ll Learn From Data Science & AI Training
            </h3>
            <ul className="space-y-4 text-gray-800 text-base md:text-lg">
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Python for data science (Pandas, NumPy, Matplotlib).</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Build & evaluate ML models with Scikit-learn.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Deep learning with TensorFlow/Keras for CV & NLP.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Apply AI to real business problems across domains.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Visualize insights with Power BI, Tableau & Python libs.</li>
              <li className="flex items-start gap-3"><span className="text-purple-600 mt-1">➤</span> Career prep: resume building, mock interviews & referrals.</li>
            </ul>
          </div>
        </div>
      </section>

      {/* Data Science & AI CTA + Cards */}
      <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-white">
            Become a Certified Data Science & AI Professional
          </h2>
          <p className="text-lg md:text-xl text-white mb-6">
            Master Data Analysis, Machine Learning, Deep Learning, and AI with expert-led real-world training.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                <li>✓ Python, SQL, ML, DL, AI</li>
                <li>✓ Real-time projects with datasets</li>
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "Pandas", "NumPy", "Scikit-learn", "TensorFlow", "Power BI"].map((tool) => (
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Data Analysis", "EDA", "Machine Learning", "Deep Learning", "NLP", "Model Deployment"].map((topic) => (
          ...
          <div className="bg-white rounded-3xl shadow-md p-6 text-left hover:shadow-xl hover:scale-[1.02] transition duration-300">
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
                ...
                <li>AI application in real use-cases</li>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-4">
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Master DS & AI with modules covering Python, SQL, ML/DL, Visualization, and MLOps basics.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-gray-900">
              ...
              <p className="text-black/90">
                Gain real-world experience with capstone projects and domain-based assignments.
              </p>
            </div>
          </div>
