  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        ...
        <li>✅ Earn a globally recognized <strong>Data Science & AI Certification</strong> for your career growth.</li>
        <li>✅ Career support: Resume building, mock interviews & job referrals in AI/Data Science roles.</li>
      </ul>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our Data Science & AI Training program is designed to build your expertise in data analysis, machine learning, deep learning, and artificial intelligence. You’ll learn key tools and techniques using Python, Scikit-learn, TensorFlow, Pandas, NumPy, and visualization libraries. This program includes hands-on projects and real-world datasets from various industries.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Master Python for data science using libraries like Pandas, NumPy, and Matplotlib.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
        ...
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Develop deep learning models with TensorFlow and Keras for image and text data.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Apply AI techniques to solve real-world problems in healthcare, finance, and marketing.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Visualize insights using Power BI, Tableau, and Python visualization libraries.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Receive career support including resume building, mock interviews, and job referrals.
        </li>
      </ul>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    >
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside space-y-1 text-base text-gray-700">
          ...
          <li>✓ Real-time data science projects</li>
          <li>✓ Resume building & interview prep</li>
          <li>✓ Learn from industry data scientists</li>
        </ul>
      </div>
    </div>
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Python", "Pandas", "NumPy", "Scikit-learn", "TensorFlow", "Power BI"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Data Analysis", "EDA", "Machine Learning", "Deep Learning", "NLP", "Model Deployment"].map((topic, i) => (
