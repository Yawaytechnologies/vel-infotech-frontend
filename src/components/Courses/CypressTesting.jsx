  ...
  export default function CypresstestingPage() {
    ...
    const course = SYLLABI.cypressTesting;
...
<ul className="space-y-3 mt-6 text-lg">
  <li>
  ✅ Join the <strong>Best Cypress Testing Training Institute</strong> to master
  end-to-end web automation testing with Cypress.
</li>
<li>
  ✅ Learn <strong>Cypress Fundamentals, JavaScript & Mocha Basics, UI Automation, API Testing, 
  Advanced Cypress Features, Framework Design, Reporting, and CI/CD Integration</strong>.
</li>
<li>
  ✅ Work on <strong>real-world Cypress testing projects</strong> including e-commerce, 
  banking, and enterprise web applications.
</li>
<li>
  ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
</li>
<li>
  ✅ Earn an industry-recognized <strong>Cypress Automation Testing Certification</strong>.
</li>
<li>
  ...
  Become an expert Cypress Tester in 2–3 Months
</p>
  ...
  Overview of Cypress Testing Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our Cypress Testing Training equips you with the skills and hands-on expertise
  required to perform fast, reliable, and scalable end-to-end testing for modern web applications.
  This course covers Cypress Fundamentals, JavaScript & Mocha Basics, UI Automation,
  API Testing, Advanced Cypress Features, Cross-browser Testing, Reporting,
  and CI/CD Integration. You’ll also work on real-world Cypress testing projects,
  build reusable automation frameworks, and receive interview preparation
...
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From Cypress Testing Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in Cypress framework, JavaScript basics, and test automation concepts.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to automate functional, integration, and end-to-end tests for web applications.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in Cypress commands, fixtures, assertions, stubbing, and mocking APIs.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world Cypress projects including e-commerce, banking, and enterprise web apps.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Implement Cypress with CI/CD tools like Jenkins, GitHub Actions, or GitLab for continuous testing.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master Cypress Testing with structured modules covering Cypress Fundamentals, JavaScript & Mocha Basics, 
  UI Automation, API Testing, Cross-browser Testing, Advanced Cypress Features, Test Automation Frameworks, 
  Assertions & Debugging, Reporting & Screenshots, CI/CD Integration, and more.
</p>
