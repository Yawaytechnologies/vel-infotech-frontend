  ...
  export default function AngularJSPage() {
    ...
    const course = SYLLABI.angularjs;
...
<li>
  ✅ Join the <strong>Best AngularJS Training Institute</strong> to master 
  frontend development, dynamic web applications, and SPA (Single Page Application) architecture.
</li>
<li>
  ✅ Learn <strong>AngularJS Fundamentals, MVC Architecture, Directives, 
  Controllers, Services & Factories, Two-way Data Binding, Dependency Injection, 
  Routing, AJAX Integration, RESTful APIs, Filters, and Best Practices</strong>.
</li>
<li>
  ✅ Work on <strong>real-world AngularJS projects</strong> including dynamic dashboards, 
  interactive forms, and enterprise-grade applications.
</li>
<li>
  ✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.
</li>
<li>
  ✅ Earn an industry-recognized <strong>AngularJS Certification</strong>.
</li>
<li>
  ...
  Become an expert AngularJS Developer in 2 Months
</p>
  ...
  Overview of AngularJS Training Course
</h2>
...
<p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
  Our AngularJS Training equips you with the skills and hands-on expertise
  required to build dynamic web applications, manage data binding, and
  implement MVC architecture. This course covers AngularJS fundamentals,
  directives, controllers, services, dependency injection, routing, forms,
  and integration with RESTful APIs. You’ll also work on real-world projects,
  practice debugging, and receive interview preparation support to kick-start
  your career in front-end development.
</p>

{/* What You’ll Learn */}
<h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-5">
  What You’ll Learn From AngularJS Training
</h3>
<ul className="space-y-4 text-gray-800 text-base md:text-lg">
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Build a strong foundation in AngularJS concepts, MVC architecture, and two-way data binding.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn to create and manage controllers, directives, services, and filters effectively.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Gain expertise in routing, form validation, and integrating AngularJS with RESTful APIs.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Work on real-world AngularJS projects including single-page applications (SPAs).
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
    Learn debugging, performance optimization, and best practices for scalable AngularJS apps.
  </li>
  <li className="flex items-start gap-3">
    <span className="text-purple-600 mt-1">➤</span>
  ...
  Master AngularJS with structured modules covering AngularJS Fundamentals, 
  MVC Architecture, Directives, Controllers, Services, Dependency Injection, 
  Routing & Navigation, Form Handling & Validation, Data Binding & Filters, 
  RESTful API Integration, Scope & Module Management, Event Handling, 
  Debugging & Testing, Performance Optimization, Best Practices for Scalable 
  Applications, and real-world project implementation.
</p>
