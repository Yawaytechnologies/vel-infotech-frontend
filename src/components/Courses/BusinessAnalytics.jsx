  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
    ...
    <div className="flex-1">
      ...
      <ul className="space-y-3 mt-6 text-lg">
        ...
        <li>✅ Work on real-time business case studies with <strong>data analysis and insights</strong>.</li>
        <li>✅ Choose <strong>flexible learning modes</strong> – Weekday / Weekend / Fast-track.</li>
        <li>✅ Earn a recognized <strong>Business Analytics Certification</strong> to strengthen your career.</li>
        <li>✅ Career support: Resume building, mock interviews & job referrals in analytics roles.</li>
      </ul>
  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our Business Analytics Training program is designed to help you derive actionable insights from data using analytical tools and decision-making frameworks. You'll learn how to use Excel, SQL, Power BI, Tableau, and basic statistics to interpret business trends, optimize processes, and make data-driven decisions in real-world scenarios.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Analyze data using Excel functions, pivot tables, and dashboards.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
        ...
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Create impactful business dashboards using Power BI and Tableau.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Understand core concepts of statistics and their application in business decisions.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Work on case studies from domains like marketing, finance, operations, and sales.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Receive career support including resume preparation, interview guidance, and job assistance.
        </li>
      </ul>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Excel", "SQL", "Power BI", "Tableau", "Google Sheets", "Python Basics"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Business Intelligence", "Data Analysis", "Dashboarding", "Reporting", "KPI Metrics", "Storytelling with Data"].map((topic, i) => (
