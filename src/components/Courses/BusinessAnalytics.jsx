...
export default function JavaCoursePage() {
  ...
  const courseJsonLd = {
    ...
    description:
      "Learn data analysis, Excel, SQL, and visualization tools. Gain skills to make data-driven business decisions and excel in analytics roles.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3 mt-6 text-lg">
              <li>
                ✅ Join the <strong>Best Business Analytics Institute</strong>{" "}
                to master data-driven decision making.
              </li>
              <li>
                ✅ Learn key tools –{" "}
                <strong>
              ...
              <li>
                ✅ Work on real-time case studies with{" "}
              ...
              <li>
                ✅ Earn a recognized{" "}
                <strong>Business Analytics Certification</strong>.
              </li>
              <li>
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                Our Business Analytics Training helps you derive actionable
                insights using Excel, SQL, Power BI, Tableau and core
                statistics. Learn to interpret trends, build dashboards,
                optimize processes and present data-driven recommendations with
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Excel
                  analysis: functions, pivot tables & dashboards.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> SQL querying:
                  joins, filtering, aggregations for insights.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> BI dashboards
                  with Power BI / Tableau and storytelling.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Statistics for
                  business decisions (A/B, correlation, basics).
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Domain case
                  studies: marketing, finance, ops & sales.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Career prep:
                  resume reviews, mock interviews & projects.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-white mb-6">
              Master Excel, SQL, Power BI, and business intelligence through
