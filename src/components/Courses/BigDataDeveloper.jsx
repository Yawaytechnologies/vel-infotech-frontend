  ...
  <div className="max-w-[100%] mx-auto px-4 md:px-10">
    <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
      ...
      <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
        Our Big Data Developer Training program equips you with the skills needed to process, analyze, and manage large-scale datasets using industry-leading tools. You'll master Hadoop, Spark, Hive, Kafka, and other technologies to build scalable big data applications and pipelines in real-world scenarios.
      </p>
      ...
      <ul className="space-y-4 text-gray-800 text-base md:text-lg">
        <li className="flex items-start gap-3">
          ...
          Work with Hadoop Distributed File System (HDFS) and MapReduce for big data processing.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Build real-time data pipelines using Apache Spark and Kafka.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Perform data querying and warehousing with Hive and Pig.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Understand NoSQL databases like HBase and MongoDB for unstructured data.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Apply big data solutions in domains like finance, e-commerce, and healthcare.
        </li>
        <li className="flex items-start gap-3">
          <span className="text-purple-600 mt-1">➤</span>
          Get career support including resume building, mock interviews, and job placement assistance.
        </li>
      </ul>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
    ...
    <div
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Hadoop", "Apache Spark", "Hive", "Kafka", "HBase", "Scala", "Python"].map((tool, i) => (
    ...
    >
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["Big Data Architecture", "Data Ingestion", "Data Processing", "Real-Time Analytics", "Data Lakes", "ETL Pipelines"].map((topic, i) => (
