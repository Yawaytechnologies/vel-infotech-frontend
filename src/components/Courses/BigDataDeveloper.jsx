...
export default function JavaCoursePage() {
  ...
  const courseJsonLd = {
    ...
    "@type": "Course",
    name: "Big Data Developer Program",
    description:
      "Learn Big Data tools like Hadoop, Spark, and Kafka. Gain hands-on experience in data processing, analytics, and building scalable big data solutions.",
    provider: {
      "@type": "Organization",
      name: "Vel InfoTech",
          ...
          <div className="max-w-[100%] mx-auto px-4 md:px-10">
            <div className="bg-[#f7f9fb] rounded-3xl shadow-md p-6 md:p-10">
              ...
              <p className="text-base md:text-lg text-gray-800 mb-8 leading-relaxed text-center md:text-left">
                ...
                Hadoop, Spark, Hive, Kafka and more. Build scalable pipelines
                and real-time streaming applications with hands-on projects.
              </p>
              ...
              <ul className="space-y-4 text-gray-800 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> HDFS,
                  MapReduce fundamentals & cluster concepts.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Spark Core,
                  SQL, Streaming with real-time pipelines.
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1">➤</span> Data
                  warehousing with Hive; ETL with Pig/Sqoop.
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  prep, resume polish & portfolio projects.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="w-full px-6 py-20 text-black bg-gradient-to-b from-[#005BAC] to-[#003c6a]">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-white mb-6">
              Learn Hadoop, Spark, Hive, Kafka, and real-time data processing
