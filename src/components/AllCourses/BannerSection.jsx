...
<p className="text-sm tracking-wide text-white uppercase">
  Successful Coaches Are Visionaries
        ...
        {/* Search Input */}
        <div className="flex items-center bg-white rounded-md overflow-hidden max-w-lg shadow-md mt-2">
          <input
            type="text"
            placeholder="What do you want to learn today?"
            className="flex-grow px-4 py-3 text-gray-800 focus:outline-none"
          />
          <button className="bg-[#0096c7] px-6 py-3 text-white font-semibold hover:bg-[#0077a7] transition">
            Search
          </button>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 mt-10 md:mt-0 flex flex-col items-center md:items-end justify-center relative animate-float">
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="bg-white shadow-md rounded-lg px-5 py-4 max-w-xs border-l-4 border-[#00b4d8] text-left">
            <h4 className="text-sm font-semibold text-gray-800 mb-1">Ronald Richards</h4>
