// src/pages/OurClientsHeader.jsx
...
export default function OurClientsHeader({
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(1200px 500px at 10% -10%, rgba(0,91,172,0.18) 0%, rgba(0,91,172,0) 60%), radial-gradient(900px 400px at 95% 0%, rgba(255,88,0,0.12) 0%, rgba(255,88,0,0) 55%), linear-gradient(180deg, rgba(0,91,172,0.06) 0%, rgba(0,91,172,0.02) 100%)",
      }}
    >
      <svg className="pointer-events-none absolute -top-24 -right-24 opacity-30" width="420" height="420" viewBox="0 0 420 420" fill="none" aria-hidden="true">
        <defs>
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[13px] font-medium ring-1 ring-slate-200" style={{ background: BRAND.surface, color: BRAND.primary }}>
            ...
            <h1 className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-slate-900">
              ...
              <span className="relative inline-block" style={{ color: BRAND.primary }}>
                hire and upskill
                <span aria-hidden className="absolute left-0 -bottom-1 h-[10px] w-full"
                      style={{ background: "linear-gradient(90deg, rgba(255,88,0,0.3), rgba(0,91,172,0.35))", clipPath: "polygon(0 80%, 100% 60%, 100% 100%, 0% 100%)" }} />
              </span>{" "}
              with confidence.
            </h1>

            <p className="mt-4 text-lg sm:text-xl text-slate-700">
              Curated shortlists of project-ready juniors and practical, stack-aligned upskilling—built around your delivery timelines. Based in Chennai, partnering with companies across India.
            </p>
  ...
  {[
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[12px] text-slate-600 font-normal">{item.desc}</span>
      </div>
      <span className="ml-auto h-1.5 w-1.5 rounded-full bg-slate-300 group-hover:bg-slate-400" />
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link
                ...
                style={{ background: `linear-gradient(135deg, ${BRAND.primary} 0%, ${BRAND.dark} 100%)` }}
              >
               Partner with us
              </Link>
          ...
          <div className="relative">
            <div className="relative rounded-[28px] p-[2px] shadow-xl"
                 style={{ background: "linear-gradient(135deg, rgba(255,88,0,0.6), rgba(0,91,172,0.65))" }}>
            ...
            <div className="pointer-events-none absolute -bottom-4 left-4 flex gap-3">
              <div className="pointer-events-auto rounded-2xl bg-white/90 backdrop-blur px-4 py-2 shadow-md ring-1 ring-slate-200">
                ...
                <p className="text-sm font-semibold text-slate-900">Resume + Mock Interviews</p>
              </div>
              
            </div>

            <div className="absolute inset-x-6 -bottom-8 h-10 blur-2xl rounded-full"
