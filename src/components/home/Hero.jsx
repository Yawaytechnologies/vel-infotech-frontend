...
const slides = [
  { image: img1, headline: "Industry-Ready Training", subtext: "Master In-Demand Skills with our expertly designed training programs in IT, Software development, Data analytics, Digital marketing, and more.", cta: "Explore Courses", link: "/all-courses" },
  { image: img2, headline: "100% Placement Assistance", subtext: "Our dedicated placement team partners with top companies to ensure you land the right job. Resume building, mock interviews, and career guidance included.", cta: "Start Your Career Journey", link: "/all-courses" },
  { image: img3, headline: "Real-Time Projects", subtext: "Gain hands-on experience by working on real-time industry projects that boost your confidence and portfolio. Learn by doing, not just watching.", cta: "See Placements", link: "/placed-students" },
  { image: img4, headline: "Join Our Talent Network", subtext: "Become part of a growing network of skilled professionals and recruiters. Get noticed by top employers and stay updated with the latest job openings.", cta: "Enquire now", link: "/about" },
];
